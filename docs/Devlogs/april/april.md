...
As April begins, we are still here, plugging away.

## New team members

In March we added four new programmers to the team. In order of appearance, they are Bruno who has added the diplomatic map mode:
-- IMAGE GOES HERE --
...
-- IMAGES OF PROVINCE WINDOW, FOCUS WINDOW, TOP BAR, POLITICS WINDOW WITH ISSUES --
...
-- IMAGE OR MAP MODE NOT ALREADY SHOWN, AND THE SAME AREA OF THE MAP AT DIFFERENT ZOOM LEVELS --
...
-- NEW-CLASSIC COMPARISON IMAGE HERE --
