...
void map::load_map(sys::state& state) {
	...
	if(state.map_provinces_texture.texture_handle == 0) {
	...
	if(state.map_terrain_texture.texture_handle == 0) {
	...
	if(state.map_rivers_texture.texture_handle == 0) {
	...
	if(state.map_terrainsheet_texture.texture_handle == 0) {
