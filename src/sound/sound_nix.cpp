...
void play_effect(sys::state& state, audio_instance& s, float volume) { state.sound_ptr->override_sound(state.sound_ptr->effect_sound, s, volume); }
void play_interface_sound(sys::state& state, audio_instance& s, float volume) { state.sound_ptr->override_sound(state.sound_ptr->interface_sound, s, volume); }
