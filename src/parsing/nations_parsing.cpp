...
void lambda_country_event(token_generator& gen, error_handler& err, effect_building_context& context) {
	event_building_context e_context{ context.outer_context, trigger::slot_contents::nation, trigger::slot_contents::nation, context.from_slot };
	auto event_result = parse_generic_event(gen, err, e_context);
...
void lambda_province_event(token_generator& gen, error_handler& err, effect_building_context& context) {
	event_building_context e_context{ context.outer_context, trigger::slot_contents::province, trigger::slot_contents::province, context.from_slot };
	auto event_result = parse_generic_event(gen, err, e_context);
