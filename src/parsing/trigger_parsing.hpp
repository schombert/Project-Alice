...
struct trigger_body {
	...
	void is_liberation_crisis(association_type a, bool value, error_handler& err, int32_t line,
	...
	void port(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::port | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "port trigger used in an incorrect scope type " +
	...
	void has_cultural_sphere(association_type a, bool value, error_handler& err, int32_t line,
		trigger_building_context& context) {
	...
	void rich_tax_above_poor(association_type a, bool value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
	...
	void election(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::election | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "election trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void crime_higher_than_education(association_type a, bool value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(uint16_t(
				trigger::crime_higher_than_education_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
	...
	void rank(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rank trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void crisis_temperature(association_type a, float value, error_handler& err, int32_t line,
		trigger_building_context& context) {
	...
	void num_of_substates(association_type a, int32_t value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
	...
	void number_of_states(association_type a, int32_t value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
	...
	void flashpoint_tension(association_type a, float value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
	...
	void rich_strata_life_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_life_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void rich_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_everyday_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_everyday_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_everyday_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_everyday_needs_pop | association_to_trigger_code(a)));
		} else {
	...
	void rich_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_luxury_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_luxury_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_luxury_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void middle_strata_life_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_life_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_life_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_life_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void middle_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_everyday_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_everyday_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_everyday_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_everyday_needs_pop | association_to_trigger_code(a)));
		} else {
	...
	void middle_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_luxury_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_luxury_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_luxury_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_luxury_needs_pop | association_to_trigger_code(a)));
		} else {
	...
	void poor_strata_life_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_life_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void poor_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_everyday_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_everyday_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_everyday_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_everyday_needs_pop | association_to_trigger_code(a)));
		} else {
	...
	void poor_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_luxury_needs_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_luxury_needs_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_luxury_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void poor_strata_militancy(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::poor_strata_militancy_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void middle_strata_militancy(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_militancy_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::middle_strata_militancy_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::middle_strata_militancy_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void rich_strata_militancy(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::rich_strata_militancy_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void literacy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "literacy trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void administration_spending(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::administration_spending_nation | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::administration_spending_state | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::administration_spending_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
	...
	void education_spending(association_type a, float value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
	...
	void rich_tax(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_tax trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void poor_tax(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_tax trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void big_producer(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value));
			...
			err.accumulated_errors += "big_producer trigger supplied with an invalid commodity (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void strata(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			if(is_fixed_token_ci(value.data(), value.data() + value.length(), "poor"))
				context.compiled_trigger.push_back(
					uint16_t(trigger::strata_poor | trigger::no_payload | association_to_bool_code(a)));
			else if(is_fixed_token_ci(value.data(), value.data() + value.length(), "rich"))
				context.compiled_trigger.push_back(
					uint16_t(trigger::strata_rich | trigger::no_payload | association_to_bool_code(a)));
			else if(is_fixed_token_ci(value.data(), value.data() + value.length(), "middle"))
				context.compiled_trigger.push_back(
					uint16_t(trigger::strata_middle | trigger::no_payload | association_to_bool_code(a)));
			else {
				err.accumulated_errors +=
			...
			err.accumulated_errors += "strata trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void state_id(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "state_id trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void is_slave(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_slave trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void government(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_governments.find(std::string(value));
			...
			err.accumulated_errors += "government trigger supplied with an invalid government type (" + err.file_name +
	...
	void constructing_cb_type(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_cb_types.find(std::string(value));
			...
			err.accumulated_errors += "constructing_cb_type trigger supplied with an invalid cb type (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void can_build_factory_in_capital_state(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_factory_names.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				context.compiled_trigger.push_back(
					uint16_t(trigger::can_build_factory_in_capital_state | association_to_bool_code(a)));
			} else {
			...
			err.accumulated_errors += "can_build_factory_in_capital_state trigger supplied with an government type (" +
									  err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void capital(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "capital trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void tech_school(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value));
			...
			err.accumulated_errors += "tech_school trigger supplied with an invalid school (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void primary_culture(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_culture_names.find(std::string(value));
			...
			err.accumulated_errors += "primary_culture trigger supplied with an invalid culture (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void has_crime(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_crimes.find(std::string(value));
			it != context.outer_context.map_of_crimes.end()) {
			if(context.main_slot == trigger::slot_contents::province) {
	...
	void pop_majority_religion(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_religion_names.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_majority_religion_province | association_to_bool_code(a)));
			} else {
			...
			err.accumulated_errors += "pop_majority_religion trigger supplied with an invalid religion (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_culture(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_culture_names.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_majority_culture_province | association_to_bool_code(a)));
			} else {
			...
			err.accumulated_errors += "pop_majority_culture trigger supplied with an invalid culture (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_issue(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_ioptions.find(std::string(value));
			...
			err.accumulated_errors += "pop_majority_issue trigger supplied with an invalid option name (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_ideology(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_majority_ideology_province | association_to_bool_code(a)));
			} else if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "pop_majority_ideology trigger supplied with an invalid ideology (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void trade_goods_in_state(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::state) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::trade_goods_in_state_province | association_to_bool_code(a)));
			} else {
			...
			err.accumulated_errors += "trade_goods_in_state trigger supplied with an invalid commodity (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}

	void culture(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(is_this(value)) {
			if(context.main_slot == trigger::slot_contents::pop) {
				if(context.main_slot == trigger::slot_contents::nation) {
	...
	void has_pop_culture(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(is_this(value)) {
			...
			err.accumulated_errors += "has_pop_culture trigger supplied with an invalid culture (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
		...
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::pop) {
				if(context.main_slot == trigger::slot_contents::nation)
					...
					context.compiled_trigger.push_back(uint16_t(
						trigger::has_pop_religion_province_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
	...
	void culture_group(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::nation) {
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::culture_group_nation_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
			...
			err.accumulated_errors += "culture_group trigger supplied with an invalid culture group (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}

	void religion(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::nation) {
				if(context.main_slot == trigger::slot_contents::nation)
			...
			if(context.from_slot == trigger::slot_contents::rebel) {
				if(context.main_slot == trigger::slot_contents::nation)
					...
					context.compiled_trigger.push_back(
						uint16_t(trigger::religion_reb | trigger::no_payload | association_to_bool_code(a)));
				else {
	...
	void terrain(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
	...
	void trade_goods(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value));
			...
			err.accumulated_errors += "trade_goods trigger supplied with an invalid commodity (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	...
	void has_faction(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_rebeltypes.find(std::string(value));
			...
			err.accumulated_errors += "has_faction trigger supplied with an invalid rebel type (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void has_unclaimed_cores(association_type a, bool value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
	...
	void is_cultural_union(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(is_fixed_token_ci(value.data(), value.data() + value.length(), "yes") ||
			is_fixed_token_ci(value.data(), value.data() + value.length(), "no")) {
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_bool | trigger::no_payload |
															association_to_bool_code(a, parse_bool(value, line, err))));
			else {
			...
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_cultural_union_tag_nation | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_cultural_union_tag_this_pop | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_cultural_union_tag_this_state | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_cultural_union_tag_this_province | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_cultural_union_tag_this_nation | association_to_bool_code(a)));
				else {
				...
				err.accumulated_errors += "is_cultural_union trigger supplied with an invalid tag (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "is_cultural_union trigger supplied with an invalid tag (" + err.file_name + ", line " +
	...
	void war(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::war_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "war trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void blockade(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "blockade trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void owns(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "owns trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void controls(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "controls trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void is_core(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(is_this(value) && context.main_slot == trigger::slot_contents::province) {
			...
			if(context.from_slot == trigger::slot_contents::rebel) {
				context.compiled_trigger.push_back(
					uint16_t(trigger::is_core_reb | trigger::no_payload | association_to_bool_code(a)));
			} else {
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				if(0 <= int_value && size_t(int_value) < context.outer_context.original_id_to_prov_id_map.size()) {
					...
					context.compiled_trigger.push_back(
						trigger::payload(context.outer_context.original_id_to_prov_id_map[int_value]).value);
				} else {
					err.accumulated_errors +=
						"owns trigger given an invalid province id (" + err.file_name + ", line " + std::to_string(line) + ")\n";
					context.compiled_trigger.push_back(trigger::payload(dcon::province_id()).value);
	...
	void owned_by(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "owned_by trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "owned_by trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "owned_by trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void exists(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_fixed_token_ci(value.data(), value.data() + value.length(), "yes") ||
			...
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(uint16_t(
					trigger::exists_bool | trigger::no_payload | association_to_bool_code(a, parse_bool(value, line, err))));
			else {
	...
	void continent(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				err.accumulated_errors += "continent trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::state) {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "casus_belli trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "casus_belli trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "military_access trigger supplied with an invalid tag (" + err.file_name +
											  ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "military_access trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
	...
	void prestige(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
			...
			err.accumulated_errors += "prestige trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void has_building(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::state) {
			if(is_fixed_token_ci(value.data(), value.data() + value.length(), "factory"))
				...
				err.accumulated_errors += "has_building trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::province) {
			if(is_fixed_token_ci(value.data(), value.data() + value.length(), "fort")) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::has_building_factory_from_province | trigger::no_payload | association_to_bool_code(a)));
					  ...
					  it != context.outer_context.map_of_factory_names.end()) {
				context.compiled_trigger.push_back(
					uint16_t(trigger::has_building_state_from_province | association_to_bool_code(a)));
				context.compiled_trigger.push_back(trigger::payload(it->second).value);
			} else {
				err.accumulated_errors += "has_building trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
	...
	void empty(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::empty | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "empty trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void has_country_modifier(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				context.compiled_trigger.push_back(
					uint16_t(trigger::has_country_modifier_province | association_to_bool_code(a)));
			} else {
			...
			err.accumulated_errors += "has_country_modifier trigger supplied with an invalid modifier (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void has_province_modifier(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value));
			...
			err.accumulated_errors += "has_province_modifier trigger supplied with an invalid modifier (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	void nationalvalue(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value));
			...
			err.accumulated_errors += "nationalvalue trigger supplied with an invalid modifier (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void region(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_state_names.find(std::string(value));
			...
			if(context.main_slot == trigger::slot_contents::province) {
				...
				err.accumulated_errors += "region trigger used in an incorrect scope type " +
										  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
	...
	void tag(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "tag trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "neighbour trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "neighbour trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					...
					context.compiled_trigger.push_back(uint16_t(
						trigger::units_in_province_this_province | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
	...
	void war_with(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "war_with trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "war_with trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "war_with trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void money(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "money trigger used in an incorrect scope type " +
									  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	...
	void is_vassal(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::is_vassal | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
	...
	void ruling_party_ideology(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value));
			...
			err.accumulated_errors += "ruling_party_ideology trigger supplied with an invalid ideology (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void is_ideology_enabled(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value));
			...
			err.accumulated_errors += "is_ideology_enabled trigger supplied with an invalid ideology (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void social_reform_want(association_type a, float value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
	...
	void is_primary_culture(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(is_this(value)) {
			if(context.main_slot == trigger::slot_contents::nation) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_nation_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_nation_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_nation_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_nation_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_state_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_state_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_state_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_province_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_province_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_province_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_province_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "is_primary_culture = this trigger used in an incorrect scope type " +
											  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_pop_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(
						uint16_t(trigger::is_primary_culture_pop_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(
						trigger::is_primary_culture_pop_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
	...
	void is_accepted_culture(association_type a, bool value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::is_accepted_culture_state | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::is_accepted_culture_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(
				uint16_t(trigger::is_accepted_culture_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "in_sphere trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "in_sphere trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
	...
	void produces(association_type a, std::string_view value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value));
			it != context.outer_context.map_of_commodity_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "produces trigger supplied with an invalid commodity (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	void has_pop_type(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_poptypes.find(std::string(value));
			...
			err.accumulated_errors += "has_pop_type trigger supplied with an invalid commodity (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
		}
	}
	...
	void average_consciousness(association_type a, float value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(
				uint16_t(trigger::average_consciousness_province | association_to_trigger_code(a)));
		} else {
	...
	void is_next_reform(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_ioptions.find(std::string(value));
			...
			err.accumulated_errors += "is_next_reform trigger supplied with an invalid issue/reform (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void controlled_by_rebels(association_type a, bool value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(
		...
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				...
				if(context.from_slot == trigger::slot_contents::rebel)
					...
					err.accumulated_errors += "controlled_by = reb trigger used in an incorrect scope type " +
											  slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
					return;
				}
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "controlled_by trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "controlled_by trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "truce_with trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "truce_with trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "is_sphere_leader_of trigger supplied with an invalid tag (" + err.file_name +
											  ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "is_sphere_leader_of trigger supplied with an invalid value (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "constructing_cb trigger supplied with an invalid tag (" + err.file_name +
											  ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "constructing_cb trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "vassal_of trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "vassal_of trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "substate_of trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "substate_of trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "is_our_vassal trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "is_our_vassal trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
	...
	void this_culture_union(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(
						trigger::this_culture_union_this_union_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(
						trigger::this_culture_union_this_union_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(
						trigger::this_culture_union_this_union_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "this_culture_union trigger supplied with an invalid tag (" + err.file_name +
											  ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "this_culture_union trigger supplied with an invalid value (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "alliance_with trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "alliance_with trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
					...
					err.accumulated_errors += "in_default trigger supplied with an invalid tag (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "in_default trigger supplied with an invalid value (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
	...
	void is_possible_vassal(association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(value.length() == 3) {
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2]));
				...
				err.accumulated_errors += "is_possible_vassal trigger supplied with an invalid tag (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
			}
		} else {
	...
	void diplomatic_influence(tr_diplomatic_influence const& value, error_handler& err, int32_t line,
		...
		if(context.main_slot != trigger::slot_contents::nation) {
			...
			if(auto it =
					context.outer_context.map_of_ident_names.find(nations::tag_to_int(value.who[0], value.who[1], value.who[2]));
				it != context.outer_context.map_of_ident_names.end()) {
				context.compiled_trigger.push_back(
					uint16_t(trigger::diplomatic_influence_tag | association_to_trigger_code(value.a)));
				context.compiled_trigger.push_back(trigger::payload(uint16_t(value.value_)).value);
				context.compiled_trigger.push_back(trigger::payload(it->second).value);
			} else {
				err.accumulated_errors += "diplomatic_influence trigger supplied with an invalid tag (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
			}
		} else {
	...
	void pop_unemployment(tr_pop_unemployment const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_from(value.type)) {
			if(context.this_slot != trigger::slot_contents::pop) {
				err.accumulated_errors += "pop_unemployment = this trigger used in an invalid context (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
				return;
			} else if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
			...
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_unemployment_nation | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_unemployment_state | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_unemployment_province | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(
					uint16_t(trigger::pop_unemployment_pop | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "pop_unemployment trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
	...
	void relation(tr_relation const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot != trigger::slot_contents::nation) {
			...
			if(context.from_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::relation_from_nation | association_to_trigger_code(value.a)));
			else if(context.from_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::relation_from_province | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "relation = from trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.this_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::relation_this_nation | association_to_trigger_code(value.a)));
			else if(context.this_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::relation_this_province | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "relation = this trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(int16_t(value.value_)).value);
	...
	void upper_house(tr_upper_house const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value.ideology));
			...
			err.accumulated_errors += "upper_house trigger supplied with an invalid ideology (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	}
	void unemployment_by_type(tr_unemployment_by_type const& value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_poptypes.find(std::string(value.type));
			...
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::unemployment_by_type_nation | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(
					uint16_t(trigger::unemployment_by_type_state | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::unemployment_by_type_province | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(
					uint16_t(trigger::unemployment_by_type_pop | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "unemployment_by_type trigger used in an invalid context (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.add_float_to_payload(value.value_);
			...
			err.accumulated_errors += "unemployment_by_type trigger supplied with an invalid pop type (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void party_loyalty(tr_party_loyalty const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value.ideology));
			...
			if(value.province_id != 0) {
				if(0 <= value.province_id &&
					size_t(value.province_id) < context.outer_context.original_id_to_prov_id_map.size()) {
					if(context.main_slot == trigger::slot_contents::nation)
						context.compiled_trigger.push_back(
						...
						err.accumulated_errors += "party_loyalty trigger used in an invalid context (" + err.file_name +
												  ", line " + std::to_string(line) + ")\n";
						return;
					}
					context.compiled_trigger.push_back(
					...
					err.accumulated_errors += "party_loyalty trigger supplied with an invalid province id (" + err.file_name +
											  ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				if(context.main_slot == trigger::slot_contents::province) {
					if(context.from_slot == trigger::slot_contents::nation)
						...
						context.compiled_trigger.push_back(
							uint16_t(trigger::party_loyalty_generic | association_to_trigger_code(value.a)));
				} else {
					err.accumulated_errors += "party_loyalty trigger used in an invalid context (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
					return;
				}
				context.compiled_trigger.push_back(trigger::payload(int16_t(value.value_)).value);
			...
			err.accumulated_errors += "party_loyalty trigger supplied with an invalid ideology (" + err.file_name + ", line " +
									  std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(context.main_slot != trigger::slot_contents::province) {
			...
			if(context.this_slot == trigger::slot_contents::nation) {
				if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "railroad"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_railroad_yes_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "naval_base"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_naval_base_yes_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "fort"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_fort_yes_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
			} else if(context.from_slot == trigger::slot_contents::nation) {
				if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "railroad"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_railroad_yes_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "naval_base"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_naval_base_yes_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "fort"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_fort_yes_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
			} else {
				err.accumulated_errors += "can_build_in_province trigger used in an invalid context (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			if(context.this_slot == trigger::slot_contents::nation) {
				if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "railroad"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_railroad_no_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "naval_base"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_naval_base_no_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "fort"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_fort_no_limit_this_nation |
																trigger::association_eq | trigger::no_payload));
			} else if(context.from_slot == trigger::slot_contents::nation) {
				if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "railroad"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_railroad_no_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "naval_base"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_naval_base_no_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
				else if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "fort"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_fort_no_limit_from_nation |
																trigger::association_eq | trigger::no_payload));
			} else {
				err.accumulated_errors += "can_build_in_province trigger used in an invalid context (" + err.file_name +
										  ", line " + std::to_string(line) + ")\n";
	...
	void can_build_railway_in_capital(tr_can_build_railway_in_capital const& value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot != trigger::slot_contents::nation) {
			err.accumulated_errors += "can_build_railway_in_capital trigger used in an invalid context (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
			return;
		} else if(value.in_whole_capital_state) {
			if(value.limit_to_world_greatest_level)
				context.compiled_trigger.push_back(uint16_t(trigger::can_build_railway_in_capital_yes_whole_state_yes_limit |
															trigger::association_eq | trigger::no_payload));
			else
				context.compiled_trigger.push_back(uint16_t(trigger::can_build_railway_in_capital_yes_whole_state_no_limit |
															trigger::association_eq | trigger::no_payload));
		} else {
			if(value.limit_to_world_greatest_level)
				context.compiled_trigger.push_back(uint16_t(trigger::can_build_railway_in_capital_no_whole_state_yes_limit |
															trigger::association_eq | trigger::no_payload));
			else
				context.compiled_trigger.push_back(uint16_t(trigger::can_build_railway_in_capital_no_whole_state_no_limit |
															trigger::association_eq | trigger::no_payload));
		}
	}
	void can_build_fort_in_capital(tr_can_build_fort_in_capital const& value, error_handler& err, int32_t line,
		trigger_building_context& context) {
		if(context.main_slot != trigger::slot_contents::nation) {
			err.accumulated_errors += "can_build_fort_in_capital trigger used in an invalid context (" + err.file_name +
									  ", line " + std::to_string(line) + ")\n";
			return;
		} else if(value.in_whole_capital_state) {
			if(value.limit_to_world_greatest_level)
				context.compiled_trigger.push_back(uint16_t(trigger::can_build_fort_in_capital_yes_whole_state_yes_limit |
															trigger::association_eq | trigger::no_payload));
			else
				context.compiled_trigger.push_back(uint16_t(
			...
			if(value.limit_to_world_greatest_level)
				...
				context.compiled_trigger.push_back(uint16_t(
					trigger::can_build_fort_in_capital_no_whole_state_no_limit | trigger::association_eq | trigger::no_payload));
		}
	}
	...
	void any_value(std::string_view label, association_type a, std::string_view value, error_handler& err, int32_t line,
		...
		if(auto it = context.outer_context.map_of_technologies.find(str_label);
			it != context.outer_context.map_of_technologies.end()) {
			if(context.main_slot != trigger::slot_contents::nation) {
				err.accumulated_errors += "named technology trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			} else {
				...
				context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
				  ...
				  itb != context.outer_context.map_of_inventions.end()) {
			if(context.main_slot != trigger::slot_contents::nation) {
				err.accumulated_errors += "named invention trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			} else {
				bool bvalue = parse_bool(value, line, err);
			...
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_ideology_name_nation | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_ideology_name_pop | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_ideology_name_province | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_ideology_name_state | association_to_trigger_code(a)));
			else {
				err.accumulated_errors += "named ideology trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_pop_type_name_nation | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_pop_type_name_pop | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_pop_type_name_province | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_pop_type_name_state | association_to_trigger_code(a)));
			else {
				err.accumulated_errors += "named pop type trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.main_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "named commodity trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(ite->second).value);
			context.add_float_to_payload(parse_float(value, line, err));
		} else if(auto itg = context.outer_context.map_of_ioptions.find(str_label);
				  itg != context.outer_context.map_of_ioptions.end()) {
			if(context.main_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_issue_name_nation | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(uint16_t(trigger::variable_issue_name_pop | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(
					uint16_t(trigger::variable_issue_name_province | association_to_trigger_code(a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(uint16_t(trigger::variable_issue_name_state | association_to_trigger_code(a)));
			else {
				err.accumulated_errors += "named issue option trigger used in an invalid context (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		...
		} else if(auto itf = context.outer_context.map_of_iissues.find(str_label);
				  itf != context.outer_context.map_of_iissues.end()) {
			if(auto itopt = context.outer_context.map_of_ioptions.find(std::string(value));
				itopt != context.outer_context.map_of_ioptions.end()) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_issue_group_name_nation | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_issue_group_name_pop | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_issue_group_name_province | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_issue_group_name_state | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "named issue trigger used in an invalid context (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
					return;
				}
				...
				err.accumulated_errors += "named issue trigger used with an invalid option name (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else if(auto ith = context.outer_context.map_of_reforms.find(str_label);
				  ith != context.outer_context.map_of_reforms.end()) {
			if(auto itopt = context.outer_context.map_of_roptions.find(std::string(value));
				itopt != context.outer_context.map_of_roptions.end()) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_reform_group_name_nation | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_reform_group_name_pop | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_reform_group_name_province | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(
						uint16_t(trigger::variable_reform_group_name_state | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "named reform trigger used in an invalid context (" + err.file_name + ", line " +
											  std::to_string(line) + ")\n";
					return;
				}
				...
				err.accumulated_errors += "named reform trigger used with an invalid option name (" + err.file_name + ", line " +
										  std::to_string(line) + ")\n";
				return;
			}
		} else {
