...
inline uint16_t association_to_trigger_code(association_type a) {
	switch(a) {
		case association_type::eq: return trigger::association_eq;
		case association_type::eq_default: return trigger::association_ge;
		case association_type::ge: return trigger::association_ge;
		case association_type::gt: return trigger::association_gt;
		case association_type::lt: return trigger::association_lt;
		case association_type::le: return trigger::association_le;
		case association_type::ne: return trigger::association_ne;
		case association_type::none: return trigger::association_ge;
		case association_type::list: return trigger::association_ge;
		default: return trigger::association_ge;
	}
}
...
inline uint16_t association_to_le_trigger_code(association_type a) {
	switch(a) {
		case association_type::eq: return trigger::association_eq;
		case association_type::eq_default: return trigger::association_le;
		case association_type::ge: return trigger::association_ge;
		case association_type::gt: return trigger::association_gt;
		case association_type::lt: return trigger::association_lt;
		case association_type::le: return trigger::association_le;
		case association_type::ne: return trigger::association_ne;
		case association_type::none: return trigger::association_le;
		case association_type::list: return trigger::association_le;
		default: return trigger::association_le;
	}
}
...
inline uint16_t association_to_bool_code(association_type a) {
	switch(a) {
		case association_type::eq: return trigger::association_eq;
		case association_type::eq_default: return trigger::association_eq;
		case association_type::ge: return trigger::association_eq;
		case association_type::gt: return trigger::association_ne;
		case association_type::lt: return trigger::association_ne;
		case association_type::le: return trigger::association_eq;
		case association_type::ne: return trigger::association_ne;
		case association_type::none: return trigger::association_ge;
		case association_type::list: return trigger::association_ge;
		default: return trigger::association_ge;
...
struct tr_work_available {
	...
	void worker(association_type, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_poptypes.find(std::string(value)); it != context.outer_context.map_of_poptypes.end()) {
			...
			err.accumulated_errors += std::string(value) + " is not a valid pop type name (" + err.file_name + " line " + std::to_string(line) + ")\n";
		}
	}
	void finish(trigger_building_context&) { }
};
...
struct trigger_body {
	...
	void ai(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "ai trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void port(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "port trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void involved_in_crisis(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::involved_in_crisis_pop | trigger::no_payload | association_to_bool_code(a, value)));
			...
			err.accumulated_errors += "involved_in_crisis trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void has_cultural_sphere(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation && context.this_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "has_cultural_sphere trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void rich_tax_above_poor(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_tax_above_poor trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void is_substate(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_substate trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void has_flashpoint(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			...
			err.accumulated_errors += "has_flashpoint trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_disarmed(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_disarmed trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void can_nationalize(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "can_nationalize trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void part_of_sphere(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "part_of_sphere trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void constructing_cb_discovered(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "constructing_cb_discovered trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void colonial_nation(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "colonial_nation trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_capital(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "is_capital trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void election(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "election trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void is_releasable_vassal(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_from(value)) {
			if(context.from_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "is_releasable_vassal trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			if(context.from_slot == trigger::slot_contents::nation)
	...
	void is_state_capital(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "is_state_capital trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void has_factories(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			...
			err.accumulated_errors += "has_factories trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void has_empty_adjacent_province(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "has_empty_adjacent_province trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void minorities(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::minorities_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::minorities_state | trigger::no_payload | association_to_bool_code(a, value)));
			...
			err.accumulated_errors += "minorities trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void culture_has_union_tag(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::culture_has_union_tag_nation | trigger::no_payload | association_to_bool_code(a, value)));
			...
			err.accumulated_errors += "culture_has_union_tag trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_colonial(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "is_colonial trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_greater_power(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_greater_power_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_greater_power_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "is_greater_power trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void can_create_vassals(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "can_create_vassals trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void has_recently_lost_war(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "has_recently_lost_war trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_mobilised(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_mobilised trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void crime_higher_than_education(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::crime_higher_than_education_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::crime_higher_than_education_state | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::crime_higher_than_education_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "crime_higher_than_education trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void civilized(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::civilized_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::civilized_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::civilized_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "civilized trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void rank(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rank trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	...
	void has_recent_imigration(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "has_recent_imigration trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	...
	void province_control_days(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "province_control_days trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void num_of_substates(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_substates trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void num_of_vassals_no_substates(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_vassals_no_substates trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void number_of_states(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "number_of_states trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	...
	void war_score(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "war_score trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void flashpoint_tension(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			...
			err.accumulated_errors += "flashpoint_tension trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void life_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "life_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void everyday_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "everyday_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void luxury_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "luxury_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void social_movement_strength(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "social_movement_strength trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void political_movement_strength(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "political_movement_strength trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void total_num_of_ports(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "total_num_of_ports trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void agree_with_ruling_party(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "agree_with_ruling_party trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void constructing_cb_progress(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "constructing_cb_progress trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void civilization_progress(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "civilization_progress trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void rich_strata_life_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_strata_life_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void rich_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_strata_everyday_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void rich_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_strata_luxury_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void middle_strata_life_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "middle_strata_life_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void middle_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			context.compiled_trigger.push_back(uint16_t(trigger::middle_strata_everyday_needs_province | association_to_trigger_code(a)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::middle_strata_everyday_needs_pop | association_to_trigger_code(a)));
		} else {
			err.accumulated_errors += "middle_strata_everyday_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void middle_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "middle_strata_luxury_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void poor_strata_life_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_strata_life_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void poor_strata_everyday_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_strata_everyday_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void poor_strata_luxury_needs(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_strata_luxury_needs trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void revanchism(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "revanchism trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void poor_strata_militancy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_strata_militancy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void middle_strata_militancy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "middle_strata_militancy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void rich_strata_militancy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_strata_militancy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void consciousness(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "consciousness trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void literacy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "literacy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void militancy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "militancy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void military_spending(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "military_spending trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	...
	void administration_spending(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "administration_spending trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void education_spending(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "education_spending trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void national_provinces_occupied(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "national_provinces_occupied trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void social_spending(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "social_spending trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void brigades_compare(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(context.this_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "brigades_compare trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "brigades_compare trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
	...
	void rich_tax(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "rich_tax trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void middle_tax(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "middle_tax trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void poor_tax(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "poor_tax trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(uint16_t(value * 100.0f));
	}
	void mobilisation_size(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "mobilisation_size trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void province_id(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "province_id trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		if(0 <= value && size_t(value) < context.outer_context.original_id_to_prov_id_map.size()) {
			...
			err.accumulated_errors += "province_id trigger given an invalid province id (" + err.file_name + ", line " + std::to_string(line) + ")\n";
	...
	void invention(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		...
		if(auto it = context.outer_context.map_of_technologies.find(std::string(value)); it != context.outer_context.map_of_technologies.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "invention trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			err.accumulated_errors += "invention trigger supplied with neither a valid technology nor a valid invention (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void big_producer(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value)); it != context.outer_context.map_of_commodity_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				context.compiled_trigger.push_back(uint16_t(trigger::big_producer | association_to_bool_code(a)));
			} else {
				err.accumulated_errors += "big_producer trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}

			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "big_producer trigger supplied with an invalid commodity (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void strata(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			if(is_fixed_token_ci(value.data(), value.data() + value.length(), "poor"))
				...
				err.accumulated_errors += "strata trigger given unknown strata (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "strata trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void life_rating(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "life_rating trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	...
	void has_empty_adjacent_state(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::has_empty_adjacent_state_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			...
			err.accumulated_errors += "has_empty_adjacent_state trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void state_id(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "state_id trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		if(0 <= value && size_t(value) < context.outer_context.original_id_to_prov_id_map.size()) {
			context.compiled_trigger.push_back(trigger::payload(context.outer_context.original_id_to_prov_id_map[value]).value);
		} else {
			err.accumulated_errors += "state_id trigger given an invalid province id (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			context.compiled_trigger.push_back(trigger::payload(dcon::province_id()).value);
		}
	}
	void cash_reserves(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "cash_reserves trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void unemployment(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "unemployment trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void is_slave(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_slave_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_slave_state | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_slave_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_slave_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "is_slave trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void is_independant(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_independant trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void has_national_minority(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::has_national_minority_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::has_national_minority_state | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "has_national_minority trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void government(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_governments.find(std::string(value)); it != context.outer_context.map_of_governments.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "government trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}

			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "government trigger supplied with an invalid government type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void constructing_cb_type(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_cb_types.find(std::string(value)); it != context.outer_context.map_of_cb_types.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "constructing_cb_type trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}

			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
			err.accumulated_errors += "constructing_cb_type trigger supplied with an invalid cb type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void can_build_factory_in_capital_state(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_factory_names.find(std::string(value)); it != context.outer_context.map_of_factory_names.end()) {
			...
			err.accumulated_errors += "can_build_factory_in_capital_state trigger supplied with an government type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void tech_school(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value)); it != context.outer_context.map_of_modifiers.end()) {
			...
			err.accumulated_errors += "tech_school trigger supplied with an invalid school (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void primary_culture(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_culture_names.find(std::string(value)); it != context.outer_context.map_of_culture_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "primary_culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}

			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "primary_culture trigger supplied with an invalid culture (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void has_crime(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_crimes.find(std::string(value)); it != context.outer_context.map_of_crimes.end()) {
			if(context.main_slot == trigger::slot_contents::province) {
				...
				err.accumulated_errors += "has_crime trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
	...
	void accepted_culture(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_culture_names.find(std::string(value)); it != context.outer_context.map_of_culture_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "accepted_culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}

			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "accepted_culture trigger supplied with an invalid culture (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_religion(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_religion_names.find(std::string(value)); it != context.outer_context.map_of_religion_names.end()) {
			...
			err.accumulated_errors += "pop_majority_religion trigger supplied with an invalid religion (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_culture(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_culture_names.find(std::string(value)); it != context.outer_context.map_of_culture_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "pop_majority_culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "pop_majority_culture trigger supplied with an invalid culture (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_issue(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ioptions.find(std::string(value)); it != context.outer_context.map_of_ioptions.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "pop_majority_issue trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
			err.accumulated_errors += "pop_majority_issue trigger supplied with an invalid option name (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void pop_majority_ideology(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value)); it != context.outer_context.map_of_ideologies.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "pop_majority_ideology trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
			err.accumulated_errors += "pop_majority_ideology trigger supplied with an invalid ideology (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void trade_goods_in_state(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value)); it != context.outer_context.map_of_commodity_names.end()) {
			if(context.main_slot == trigger::slot_contents::state) {
				...
				err.accumulated_errors += "trade_goods_in_state trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "trade_goods_in_state trigger supplied with an invalid commodity (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void culture(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value)) {
			if(context.main_slot == trigger::slot_contents::pop) {
				if(context.main_slot == trigger::slot_contents::nation) {
					context.compiled_trigger.push_back(uint16_t(trigger::culture_this_nation | trigger::no_payload | association_to_bool_code(a)));
				} else if(context.main_slot == trigger::slot_contents::state) {
					...
					err.accumulated_errors += "culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "culture = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.main_slot == trigger::slot_contents::pop && context.from_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "culture = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(is_reb(value)) {
			if(context.from_slot != trigger::slot_contents::rebel) {
				err.accumulated_errors += "culture = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			} else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(uint16_t(trigger::culture_pop_reb | trigger::no_payload | association_to_bool_code(a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(uint16_t(trigger::culture_state_reb | trigger::no_payload | association_to_bool_code(a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(uint16_t(trigger::culture_province_reb | trigger::no_payload | association_to_bool_code(a)));
			else if(context.main_slot == trigger::slot_contents::nation)
		...
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::pop) {
				if(context.main_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "has_pop_culture = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "has_pop_culture = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "has_pop_culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "has_pop_culture trigger supplied with an invalid culture (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
		...
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::pop) {
				if(context.main_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "has_pop_religion = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "has_pop_religion = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			err.accumulated_errors += "has_pop_religion trigger supplied with an invalid religion (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void culture_group(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::nation) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_nation_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "culture_group = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(context.this_slot == trigger::slot_contents::state) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_nation_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_nation_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_nation_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
			...
			if(context.from_slot == trigger::slot_contents::nation) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_nation_from_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "culture_group = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "culture_group = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(context.from_slot == trigger::slot_contents::rebel) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_reb_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::culture_group_reb_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "culture_group = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "culture_group = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "culture_group trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "culture_group trigger supplied with an invalid culture group (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	...
	void religion(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value)) {
			if(context.this_slot == trigger::slot_contents::nation) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "religion = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(context.this_slot == trigger::slot_contents::state) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
				...
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
			...
			if(context.from_slot == trigger::slot_contents::nation) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_from_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_from_nation | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "religion = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "religion = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(context.from_slot == trigger::slot_contents::rebel) {
				if(context.main_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_nation_reb | trigger::no_payload | association_to_bool_code(a)));
				else if(context.main_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::religion_reb | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "religion = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "religion = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "religion trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "religion trigger supplied with an invalid religion (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void terrain(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_terrain_types.find(std::string(value)); it != context.outer_context.map_of_terrain_types.end()) {
			if(context.main_slot == trigger::slot_contents::pop) {
				...
				err.accumulated_errors += "terrain trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
			err.accumulated_errors += "terrain trigger supplied with an invalid terrain (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void trade_goods(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value)); it != context.outer_context.map_of_commodity_names.end()) {
			if(context.main_slot == trigger::slot_contents::province) {
				...
				err.accumulated_errors += "trade_goods trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "trade_goods trigger supplied with an invalid commodity (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void is_secondary_power(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_secondary_power_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "is_secondary_power trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void has_faction(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_rebeltypes.find(std::string(value)); it != context.outer_context.map_of_rebeltypes.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "has_faction trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
			err.accumulated_errors += "has_faction trigger supplied with an invalid rebel type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void has_unclaimed_cores(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "has_unclaimed_cores trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void is_cultural_union(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_fixed_token_ci(value.data(), value.data() + value.length(), "yes") || is_fixed_token_ci(value.data(), value.data() + value.length(), "no")) {
			if(context.main_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "is_cultural_union = bool trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(is_this(value)) {
			if(context.main_slot == trigger::slot_contents::pop && context.this_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_this_self_pop | trigger::no_payload | association_to_bool_code(a)));
			else if(context.main_slot == trigger::slot_contents::pop && context.this_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_pop_this_pop | trigger::no_payload | association_to_bool_code(a)));
			else if(context.main_slot == trigger::slot_contents::nation) {
				if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.from_slot == trigger::slot_contents::rebel)
					...
					err.accumulated_errors += "is_cultural_union = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
				err.accumulated_errors += "is_cultural_union = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			...
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
				...
				if(context.main_slot == trigger::slot_contents::nation)
					...
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_tag_this_province | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_cultural_union_tag_this_nation | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "is_cultural_union = tag trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
				context.compiled_trigger.push_back(trigger::payload(it->second).value);
			} else {
				err.accumulated_errors += "is_cultural_union trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "is_cultural_union trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	...
	void can_build_factory(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::can_build_factory_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::can_build_factory_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "can_build_factory trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void war(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			context.compiled_trigger.push_back(uint16_t(trigger::war_nation | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::war_pop | trigger::no_payload | association_to_bool_code(a, value)));
		} else {
			err.accumulated_errors += "war trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void war_exhaustion(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "war_exhaustion trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	...
	void blockade(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "blockade trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void owns(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "owns trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		if(0 <= value && size_t(value) < context.outer_context.original_id_to_prov_id_map.size()) {
			context.compiled_trigger.push_back(trigger::payload(context.outer_context.original_id_to_prov_id_map[value]).value);
		} else {
			err.accumulated_errors += "owns trigger given an invalid province id (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			context.compiled_trigger.push_back(trigger::payload(dcon::province_id()).value);
		}
	}
	void controls(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "controls trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		if(0 <= value && size_t(value) < context.outer_context.original_id_to_prov_id_map.size()) {
			context.compiled_trigger.push_back(trigger::payload(context.outer_context.original_id_to_prov_id_map[value]).value);
		} else {
			err.accumulated_errors += "controls trigger given an invalid province id (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			context.compiled_trigger.push_back(trigger::payload(dcon::province_id()).value);
		}
	}
	...
	void is_core(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value) && context.main_slot == trigger::slot_contents::province) {
			if(context.this_slot == trigger::slot_contents::nation) {
				context.compiled_trigger.push_back(uint16_t(trigger::is_core_this_nation | trigger::no_payload | association_to_bool_code(a)));
			} else if(context.this_slot == trigger::slot_contents::state) {
				context.compiled_trigger.push_back(uint16_t(trigger::is_core_this_state | trigger::no_payload | association_to_bool_code(a)));
			} else if(context.this_slot == trigger::slot_contents::province) {
				context.compiled_trigger.push_back(uint16_t(trigger::is_core_this_province | trigger::no_payload | association_to_bool_code(a)));
			} else if(context.this_slot == trigger::slot_contents::pop) {
				context.compiled_trigger.push_back(uint16_t(trigger::is_core_this_pop | trigger::no_payload | association_to_bool_code(a)));
			} else {
				err.accumulated_errors += "is_core = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.from_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "is_core = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.from_slot == trigger::slot_contents::rebel) {
				...
				err.accumulated_errors += "is_core = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "is_core trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
				...
				err.accumulated_errors += "is_core trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "is_core trigger supplied with an invalid argument (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void num_of_revolts(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_revolts trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void revolt_percentage(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "revolt_percentage trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void num_of_cities(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value) && context.main_slot == trigger::slot_contents::nation) {
			if(context.this_slot == trigger::slot_contents::nation) {
				context.compiled_trigger.push_back(uint16_t(trigger::num_of_cities_this_nation | trigger::no_payload | association_to_trigger_code(a)));
			} else if(context.this_slot == trigger::slot_contents::state) {
				context.compiled_trigger.push_back(uint16_t(trigger::num_of_cities_this_province | trigger::no_payload | association_to_trigger_code(a)));
			} else if(context.this_slot == trigger::slot_contents::province) {
				context.compiled_trigger.push_back(uint16_t(trigger::num_of_cities_this_state | trigger::no_payload | association_to_trigger_code(a)));
			} else if(context.this_slot == trigger::slot_contents::pop) {
				...
				err.accumulated_errors += "num_of_cities = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.from_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "num_of_cities = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_cities trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void num_of_ports(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_ports trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void num_of_allies(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_allies trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void num_of_vassals(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "num_of_vassals trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
		...
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "owned_by = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "owned_by = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "owned_by trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "owned_by trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "owned_by trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void exists(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_fixed_token_ci(value.data(), value.data() + value.length(), "yes") || is_fixed_token_ci(value.data(), value.data() + value.length(), "no")) {
			if(context.main_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "exists = bool trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
			}
		} else if(value.length() == 3) {
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
				...
				err.accumulated_errors += "exists trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
			
		} else {
			err.accumulated_errors += "exists trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation) {
					...
					err.accumulated_errors += "continent = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation) {
					...
					err.accumulated_errors += "continent = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
				...
				err.accumulated_errors += "continent trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::state) {
			if(is_this(value)) {
			...
			err.accumulated_errors += "continent trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void casus_belli(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::casus_belli_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::casus_belli_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::casus_belli_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "casus_belli = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "casus_belli = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "casus_belli trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "casus_belli trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "casus_belli trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void military_access(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::military_access_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::military_access_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::military_access_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "military_access = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "military_access = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "military_access trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "military_access trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "military_access trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void prestige(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::prestige_this_pop | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::prestige_this_state | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::prestige_this_province | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "prestige = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "prestige = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
			...
			err.accumulated_errors += "prestige trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void has_building(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			if(is_fixed_token_ci(value.data(), value.data() + value.length(), "factory"))
				...
				err.accumulated_errors += "has_building trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::province) {
	...
	void has_country_modifier(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value)); it != context.outer_context.map_of_modifiers.end()) {
			...
			err.accumulated_errors += "has_country_modifier trigger supplied with an invalid modifier (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void has_province_modifier(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value)); it != context.outer_context.map_of_modifiers.end()) {
			if(context.main_slot == trigger::slot_contents::province) {
				...
				err.accumulated_errors += "has_province_modifier trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "has_province_modifier trigger supplied with an invalid modifier (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void nationalvalue(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_modifiers.find(std::string(value)); it != context.outer_context.map_of_modifiers.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "nationalvalue trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "nationalvalue trigger supplied with an invalid modifier (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void region(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_state_names.find(std::string(value)); it != context.outer_context.map_of_state_names.end()) {
			if(context.main_slot == trigger::slot_contents::province) {
				...
				err.accumulated_errors += "region trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				...
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "tag = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "tag trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "tag trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else if(context.main_slot == trigger::slot_contents::pop) {
			if(value.length() == 3) {
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "neighbour = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "neighbour = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "neighbour trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "neighbour trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "neighbour trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void units_in_province(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::units_in_province_this_nation | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::units_in_province_this_state | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::units_in_province_this_province | trigger::no_payload | association_to_trigger_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
	...
	void war_with(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::war_with_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::war_with_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::war_with_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::war_with_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "war_with = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "war_with = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "war_with trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "war_with trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "war_with trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void total_amount_of_divisions(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "total_amount_of_divisions trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void money(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "money trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void lost_national(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "lost_national trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void is_vassal(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "is_vassal trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void ruling_party_ideology(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value)); it != context.outer_context.map_of_ideologies.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "ruling_party_ideology trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second.id).value);
		} else {
	...
	void political_reform_want(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "political_reform_want trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void social_reform_want(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "social_reform_want trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void total_amount_of_ships(association_type a, int32_t value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "total_amount_of_ships trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.compiled_trigger.push_back(trigger::payload(uint16_t(value)).value);
	}
	void plurality(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "plurality trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value / 100.0f);
	}
	void corruption(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "corruption trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void is_state_religion(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_state_religion_state | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::province) {
			context.compiled_trigger.push_back(uint16_t(trigger::is_state_religion_province | trigger::no_payload | association_to_bool_code(a, value)));
		} else if(context.main_slot == trigger::slot_contents::pop) {
			...
			err.accumulated_errors += "is_state_religion trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_primary_culture(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_this(value)) {
			if(context.main_slot == trigger::slot_contents::nation) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_nation_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					...
					err.accumulated_errors += "is_primary_culture = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(context.main_slot == trigger::slot_contents::state) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_state_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_state_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_state_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_province_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_province_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_province_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
				...
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_pop_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_pop_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_pop_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
			...
			if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_state | trigger::no_payload | association_to_bool_code(a, v)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(uint16_t(trigger::is_primary_culture_province | trigger::no_payload | association_to_bool_code(a, v)));
			else if(context.main_slot == trigger::slot_contents::pop)
				...
				err.accumulated_errors += "is_primary_culture trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		}
	}
	void is_accepted_culture(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::state) {
	...
	void is_coastal(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			...
			err.accumulated_errors += "is_coastal trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void in_sphere(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::in_sphere_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::in_sphere_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::in_sphere_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::in_sphere_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "in_sphere = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "in_sphere = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "in_sphere trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "in_sphere trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "in_sphere trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void produces(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_commodity_names.find(std::string(value)); it != context.outer_context.map_of_commodity_names.end()) {
			if(context.main_slot == trigger::slot_contents::nation) {
				...
				err.accumulated_errors += "produces trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
	...
	void has_pop_type(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_poptypes.find(std::string(value)); it != context.outer_context.map_of_poptypes.end()) {
			...
			err.accumulated_errors += "has_pop_type trigger supplied with an invalid commodity (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	}
	void total_pops(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "total_pops trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void average_militancy(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "average_militancy trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void average_consciousness(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "average_consciousness trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	...
	void recruited_percentage(association_type a, float value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			...
			err.accumulated_errors += "recruited_percentage trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
		context.add_float_to_payload(value);
	}
	void has_culture_core(association_type a, bool value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::pop) {
			context.compiled_trigger.push_back(uint16_t(trigger::has_culture_core | trigger::no_payload | association_to_bool_code(a, value)));
			...
			err.accumulated_errors += "has_culture_core trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	...
	void controlled_by(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::province) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "controlled_by = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "controlled_by = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_reb(value)) {
				if(context.from_slot == trigger::slot_contents::rebel)
					...
					err.accumulated_errors += "controlled_by = reb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_fixed_token_ci(value.data(), value.data() + value.length(), "owner")) {
				context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_owner | trigger::no_payload | association_to_bool_code(a)));
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					context.compiled_trigger.push_back(uint16_t(trigger::controlled_by_tag | association_to_bool_code(a)));
					context.compiled_trigger.push_back(trigger::payload(it->second).value);
				} else {
					err.accumulated_errors += "controlled_by trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "controlled_by trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "controlled_by trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void truce_with(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::truce_with_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::truce_with_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::truce_with_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::truce_with_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "truce_with = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "truce_with = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "truce_with trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "truce_with trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "truce_with trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_sphere_leader_of(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_sphere_leader_of_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_sphere_leader_of_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_sphere_leader_of_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "is_sphere_leader_of = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "is_sphere_leader_of = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "is_sphere_leader_of trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "is_sphere_leader_of trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "is_sphere_leader_of trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void constructing_cb(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::constructing_cb_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::constructing_cb_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::constructing_cb_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "constructing_cb = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "constructing_cb = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "constructing_cb trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "constructing_cb trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "constructing_cb trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "vassal_of = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "vassal_of = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "vassal_of trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "vassal_of trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "vassal_of trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void substate_of(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::substate_of_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::substate_of_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::substate_of_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::substate_of_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "substate_of = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "substate_of = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "substate_of trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "substate_of trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "substate_of trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void is_our_vassal(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::is_our_vassal_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::is_our_vassal_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::is_our_vassal_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::is_our_vassal_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "is_our_vassal = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "is_our_vassal = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "is_our_vassal trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "is_our_vassal trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "is_our_vassal trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void this_culture_union(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "this_culture_union = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_fixed_token_ci(value.data(), value.data() + value.length(), "this_union")) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_union_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_union_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::this_culture_union_this_union_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "this_culture_union = this_union trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "this_culture_union = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "this_culture_union trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "this_culture_union trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "this_culture_union trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void alliance_with(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::alliance_with_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::alliance_with_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::alliance_with_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					context.compiled_trigger.push_back(uint16_t(trigger::alliance_with_this_pop | trigger::no_payload | association_to_bool_code(a)));
				else {
					err.accumulated_errors += "alliance_with = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "alliance_with = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
					...
					err.accumulated_errors += "alliance_with trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				}
			} else {
				err.accumulated_errors += "alliance_with trigger supplied with an invalid value (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
		} else {
			err.accumulated_errors += "alliance_with trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "in_default = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "in_default = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(value.length() == 3) {
				if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
			...
			err.accumulated_errors += "in_default trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void industrial_score(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::industrial_score_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::industrial_score_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::industrial_score_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "industrial_score = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "industrial_score = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
			...
			err.accumulated_errors += "industrial_score trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void military_score(association_type a, std::string_view value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot == trigger::slot_contents::nation) {
			if(is_this(value)) {
				if(context.this_slot == trigger::slot_contents::nation)
					context.compiled_trigger.push_back(uint16_t(trigger::military_score_this_nation | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::state)
					context.compiled_trigger.push_back(uint16_t(trigger::military_score_this_state | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::province)
					context.compiled_trigger.push_back(uint16_t(trigger::military_score_this_province | trigger::no_payload | association_to_bool_code(a)));
				else if(context.this_slot == trigger::slot_contents::pop)
					...
					err.accumulated_errors += "military_score = this trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else if(is_from(value)) {
				if(context.from_slot == trigger::slot_contents::nation)
					...
					err.accumulated_errors += "military_score = from trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
			} else {
			...
			err.accumulated_errors += "military_score trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(value.length() == 3) {
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value[0], value[1], value[2])); it != context.outer_context.map_of_ident_names.end()) {
				if(context.main_slot == trigger::slot_contents::nation) {
					...
					err.accumulated_errors += "is_possible_vassal trigger used in an incorrect scope type " + slot_contents_to_string(context.main_slot) + "(" + err.file_name + ", line " + std::to_string(line) + ")\n";
					return;
				}
				context.compiled_trigger.push_back(trigger::payload(it->second).value);
			} else {
				err.accumulated_errors += "is_possible_vassal trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "is_possible_vassal trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
		}
	...
	void diplomatic_influence(tr_diplomatic_influence const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot != trigger::slot_contents::nation) {
			...
			if(context.from_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(uint16_t(trigger::diplomatic_influence_from_nation | association_to_trigger_code(value.a)));
			else if(context.from_slot == trigger::slot_contents::province)
			...
			if(context.this_slot == trigger::slot_contents::nation)
				context.compiled_trigger.push_back(uint16_t(trigger::diplomatic_influence_this_nation | association_to_trigger_code(value.a)));
			else if(context.this_slot == trigger::slot_contents::province)
			...
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value.who[0], value.who[1], value.who[2])); it != context.outer_context.map_of_ident_names.end()) {
				context.compiled_trigger.push_back(uint16_t(trigger::diplomatic_influence_tag | association_to_trigger_code(value.a)));
				context.compiled_trigger.push_back(trigger::payload(uint16_t(value.value_)).value);
				context.compiled_trigger.push_back(trigger::payload(it->second).value);
			} else {
				err.accumulated_errors += "diplomatic_influence trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "diplomatic_influence trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
	...
	void pop_unemployment(tr_pop_unemployment const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(is_from(value.type)) {
			if(context.this_slot != trigger::slot_contents::pop) {
				...
				context.compiled_trigger.push_back(uint16_t(trigger::pop_unemployment_nation_this_pop | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::state)
				context.compiled_trigger.push_back(uint16_t(trigger::pop_unemployment_state_this_pop | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::province)
				context.compiled_trigger.push_back(uint16_t(trigger::pop_unemployment_province_this_pop | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "pop_unemployment = this trigger used in an invalid context (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.add_float_to_payload(value.value_);
		} else if(auto it = context.outer_context.map_of_poptypes.find(std::string(value.type)); it != context.outer_context.map_of_poptypes.end()) {
			if(context.main_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "pop_unemployment trigger used in an invalid context (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			err.accumulated_errors += "pop_unemployment trigger supplied with an invalid pop type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void relation(tr_relation const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(context.main_slot != trigger::slot_contents::nation) {
			...
			if(context.from_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "relation = from trigger used in an invalid context (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			...
			if(context.this_slot == trigger::slot_contents::nation)
				...
				err.accumulated_errors += "relation = this trigger used in an invalid context (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.compiled_trigger.push_back(trigger::payload(int16_t(value.value_)).value);
		} else if(value.who.length() == 3) {
			if(auto it = context.outer_context.map_of_ident_names.find(nations::tag_to_int(value.who[0], value.who[1], value.who[2])); it != context.outer_context.map_of_ident_names.end()) {
				...
				err.accumulated_errors += "relation trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			}
		} else {
			err.accumulated_errors += "relation trigger supplied with an invalid tag (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
	...
	void upper_house(tr_upper_house const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value.ideology)); it != context.outer_context.map_of_ideologies.end()) {
			...
			err.accumulated_errors += "upper_house trigger supplied with an invalid ideology (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
	void unemployment_by_type(tr_unemployment_by_type const& value, error_handler& err, int32_t line, trigger_building_context& context) {
		if(auto it = context.outer_context.map_of_poptypes.find(std::string(value.type)); it != context.outer_context.map_of_poptypes.end()) {
			if(context.main_slot == trigger::slot_contents::nation)
				...
				context.compiled_trigger.push_back(uint16_t(trigger::unemployment_by_type_province | association_to_trigger_code(value.a)));
			else if(context.main_slot == trigger::slot_contents::pop)
				context.compiled_trigger.push_back(uint16_t(trigger::unemployment_by_type_pop | association_to_trigger_code(value.a)));
			else {
				err.accumulated_errors += "unemployment_by_type trigger used in an invalid context (" + err.file_name + ", line " + std::to_string(line) + ")\n";
				return;
			}
			context.add_float_to_payload(value.value_);
			context.compiled_trigger.push_back(trigger::payload(it->second).value);
		} else {
			err.accumulated_errors += "unemployment_by_type trigger supplied with an invalid pop type (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(auto it = context.outer_context.map_of_ideologies.find(std::string(value.ideology)); it != context.outer_context.map_of_ideologies.end()) {
			if(value.province_id != 0) {
				if(0 <= value.province_id && size_t(value.province_id) < context.outer_context.original_id_to_prov_id_map.size()) {
					if(context.main_slot == trigger::slot_contents::nation)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_nation_province_id | association_to_trigger_code(value.a)));
					else if(context.from_slot == trigger::slot_contents::nation)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_from_nation_province_id | association_to_trigger_code(value.a)));
					else if(context.main_slot == trigger::slot_contents::province)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_province_province_id | association_to_trigger_code(value.a)));
					else if(context.from_slot == trigger::slot_contents::province)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_from_province_province_id | association_to_trigger_code(value.a)));
					else {
				...
				if(context.main_slot == trigger::slot_contents::province) {
					if(context.from_slot == trigger::slot_contents::nation)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_from_nation_scope_province | association_to_trigger_code(value.a)));
					else if(context.from_slot == trigger::slot_contents::province)
						context.compiled_trigger.push_back(uint16_t(trigger::party_loyalty_from_province_scope_province | association_to_trigger_code(value.a)));
					else
			...
			err.accumulated_errors += "party_loyalty trigger supplied with an invalid ideology (" + err.file_name + ", line " + std::to_string(line) + ")\n";
			return;
		}
	}
		...
		if(context.main_slot != trigger::slot_contents::province) {
			...
			if(context.this_slot == trigger::slot_contents::nation) {
				if(is_fixed_token_ci(value.building.data(), value.building.data() + value.building.length(), "railroad"))
					context.compiled_trigger.push_back(uint16_t(trigger::can_build_in_province_railroad_yes_limit_this_nation | trigger::association_eq | trigger::no_payload));
