...
public:
	...
	MOD_NAT_FUNCTION(poor_life_needs)
	MOD_NAT_FUNCTION(rich_life_needs)
	MOD_NAT_FUNCTION(middle_life_needs)
	MOD_NAT_FUNCTION(poor_everyday_needs)
	MOD_NAT_FUNCTION(middle_everyday_needs)
	MOD_NAT_FUNCTION(rich_everyday_needs)
	MOD_NAT_FUNCTION(poor_luxury_needs)
	MOD_NAT_FUNCTION(middle_luxury_needs)
	MOD_NAT_FUNCTION(rich_luxury_needs)
