...
void acting_modifiers_description_province(sys::state& state, text::layout_base& layout, dcon::province_id p, int32_t identation,
	...
	if(state.national_definitions.infrastructure) {
		active_single_modifier_description(state, layout, state.national_definitions.infrastructure, identation, header, nmid,
				state.world.province_get_railroad_level(p) * state.economy_definitions.building_definitions[int32_t(economy::province_building_type::railroad)].infrastructure);
	}
	if(state.economy_definitions.building_definitions[int32_t(economy::province_building_type::fort)].province_modifier) {
		active_single_modifier_description(state, layout, state.economy_definitions.building_definitions[int32_t(economy::province_building_type::fort)].province_modifier, identation,
	...
	if(state.economy_definitions.building_definitions[int32_t(economy::province_building_type::naval_base)].province_modifier) {
		active_single_modifier_description(state, layout, state.economy_definitions.building_definitions[int32_t(economy::province_building_type::naval_base)].province_modifier,
