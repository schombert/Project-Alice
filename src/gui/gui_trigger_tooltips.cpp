...
void display_with_comparison(uint16_t trigger_code, text::substitution left_label, text::substitution value, sys::state& ws, text::layout_base& layout, text::layout_box& box) {
	...
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, cmp_code_to_fixed_ui(trigger_code)), text::text_color::white);
	text::add_space_to_layout_box(ws, layout, box);
...
void display_with_has_comparison(uint16_t trigger_code, text::substitution left_label, text::substitution value, sys::state& ws, text::layout_base& layout, text::layout_box& box) {
	...
	text::add_to_layout_box(ws, layout, box, left_label, text::text_color::white);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, cmp_has_code_to_fixed_ui(trigger_code)), text::text_color::white);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, value, text::text_color::white);
}
...
#define TRIGGER_DISPLAY_PARAMS uint16_t const *tval, sys::state &ws, text::layout_base &layout, int32_t primary_slot, int32_t this_slot, int32_t from_slot, int32_t indentation, bool show_condition
...
void tf_x_owned_province_scope_state(TRIGGER_DISPLAY_PARAMS) {
	{
		...
		text::add_space_to_layout_box(ws, layout, box);
		text::add_to_layout_box(ws, layout, box, primary_slot != -1 ? text::get_dynamic_state_name(ws, trigger::to_state(primary_slot)) : text::produce_simple_string(ws, "singular_state"));
		text::close_layout_box(layout, box);
	}
...
void tf_x_owned_province_scope_nation(TRIGGER_DISPLAY_PARAMS) {
	{
		...
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "owned_province"));
		text::add_space_to_layout_box(ws, layout, box);
		text::add_to_layout_box(ws, layout, box, primary_slot != -1 ? text::produce_simple_string(ws, ws.world.nation_get_name(trigger::to_nation(primary_slot))) : text::produce_simple_string(ws, "singular_nation"));
		text::close_layout_box(layout, box);
	}
...
void tf_owner_scope_state(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, primary_slot != -1 ? trigger::to_generic(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(primary_slot))) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && primary_slot != -1);
}
void tf_owner_scope_province(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, primary_slot != -1 ? trigger::to_generic(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(primary_slot))) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && primary_slot != -1);
}
void tf_controller_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, primary_slot != -1 ? trigger::to_generic(ws.world.province_get_nation_from_province_control(trigger::to_prov(primary_slot))) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && primary_slot != -1);
}
...
void tf_country_scope_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, primary_slot != -1 ? trigger::to_generic(nations::owner_of_pop(ws, trigger::to_pop(primary_slot))) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && primary_slot != -1);
}
...
void tf_this_scope_state(TRIGGER_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
		text::add_to_layout_box(ws, layout, box, this_slot != -1 ? text::get_dynamic_state_name(ws, trigger::to_state(this_slot)) : text::produce_simple_string(ws, "this_state"));
		text::close_layout_box(layout, box);
	}
...
void tf_this_scope_province(TRIGGER_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
		text::add_to_layout_box(ws, layout, box, this_slot != -1 ? text::produce_simple_string(ws, ws.world.province_get_name(trigger::to_prov(this_slot))) : text::produce_simple_string(ws, "this_province"));
		text::close_layout_box(layout, box);
	}
...
void tf_from_scope_state(TRIGGER_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
		text::add_to_layout_box(ws, layout, box, from_slot != -1 ? text::get_dynamic_state_name(ws, trigger::to_state(from_slot)) : text::produce_simple_string(ws, "from_state"));
		text::close_layout_box(layout, box);
	}
...
void tf_from_scope_province(TRIGGER_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
		text::add_to_layout_box(ws, layout, box, from_slot != -1 ? text::produce_simple_string(ws, ws.world.province_get_name(trigger::to_prov(from_slot))) : text::produce_simple_string(ws, "from_province"));
		text::close_layout_box(layout, box);
	}
...
void tf_cultural_union_scope(TRIGGER_DISPLAY_PARAMS) {
...

	{
		...
		text::add_space_to_layout_box(ws, layout, box);
		text::add_to_layout_box(ws, layout, box, cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "singular_nation"));
		text::close_layout_box(layout, box);
	}
...
void tf_sphere_owner_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, primary_slot != -1 ? trigger::to_generic(ws.world.nation_get_in_sphere_of((trigger::to_nation(primary_slot)))) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && primary_slot != -1);
}
void tf_independence_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, r_holder ? trigger::to_generic(r_holder) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && bool(r_holder));
}
void tf_flashpoint_tag_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, fp_nation ? trigger::to_generic(fp_nation) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && bool(fp_nation));
}
void tf_crisis_state_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, cstate, this_slot, from_slot, indentation + indentation_amount, show_condition && cstate != -1);
}
...
void tf_tag_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, tag_holder ? trigger::to_generic(tag_holder) : -1, this_slot, from_slot, indentation + indentation_amount, show_condition && tag_holder);
}
void tf_integer_scope(TRIGGER_DISPLAY_PARAMS) {
	...
	display_subtriggers(tval, ws, layout, trigger::to_generic(p), this_slot, from_slot, indentation + indentation_amount, show_condition);
}
...
void tf_state_id_province(TRIGGER_DISPLAY_PARAMS) {
	auto it = (tval[0] & trigger::association_mask) == trigger::association_eq ? ws.key_to_text_sequence.find(std::string_view("belongs_to_same_state")) : ws.key_to_text_sequence.find(std::string_view("does_not_belong_to_same_state"));
...
void tf_state_id_state(TRIGGER_DISPLAY_PARAMS) {
	auto it = (tval[0] & trigger::association_mask) == trigger::association_eq ? ws.key_to_text_sequence.find(std::string_view("contains_blank")) : ws.key_to_text_sequence.find(std::string_view("does_not_contain_blank"));
	if(it != ws.key_to_text_sequence.end()) {
		text::substitution_map map;
		text::add_to_substitution_map(map, text::variable_type::text, trigger::payload(tval[1]).prov_id);
...
void tf_culture_group_nation_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture_group"), cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "this_nation_culture_group"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_culture_group_nation_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture_group"), cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "from_nation_culture_group"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_culture_group_nation_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture_group"), cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "this_province_culture_group"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_culture_group_nation_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture_group"), cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "this_state_culture_group"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_culture_group_nation_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture_group"), cg ? text::produce_simple_string(ws, ws.world.culture_group_get_name(cg)) : text::produce_simple_string(ws, "this_pop_culture_group"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_religion_reb(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "rebel_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "from_nation_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "this_nation_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "this_state_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "this_province_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), rc ? text::produce_simple_string(ws, ws.world.religion_get_name(rc)) : text::produce_simple_string(ws, "this_pop_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_can_build_factory_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "capitalists_can_build" : "capitalists_cannot_build"));
	text::close_layout_box(layout, box);
}
...
void tf_owns(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "owns" : "does_not_own"));
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, ws.world.province_get_name(p)));
	text::close_layout_box(layout, box);
}
void tf_controls(TRIGGER_DISPLAY_PARAMS) {
	...
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "controls" : "does_not_control"));
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, ws.world.province_get_name(p)));
	text::close_layout_box(layout, box);
}
void tf_is_core_integer(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, ws.world.province_get_name(trigger::payload(tval[1]).prov_id)));
	text::close_layout_box(layout, box);
}
...
void tf_is_core_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		text::add_to_layout_box(ws, layout, box, ws.world.nation_get_name(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot))));
	else
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "this_nation"));
	text::close_layout_box(layout, box);
}
void tf_is_core_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		text::add_to_layout_box(ws, layout, box, ws.world.nation_get_name(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot))));
	else
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "this_nation"));
	text::close_layout_box(layout, box);
}
...
void tf_num_of_cities_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	display_with_comparison(tval[0], text::produce_simple_string(ws, "num_owned_provinces"), text::produce_simple_string(ws, "num_provinces_owned_by"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, this_slot != -1 ? text::produce_simple_string(ws, ws.world.nation_get_name(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot)))) : text::produce_simple_string(ws, "this_nation"));
	text::close_layout_box(layout, box);
}
void tf_num_of_cities_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	display_with_comparison(tval[0], text::produce_simple_string(ws, "num_owned_provinces"), text::produce_simple_string(ws, "num_provinces_owned_by"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, this_slot != -1 ? text::produce_simple_string(ws, ws.world.nation_get_name(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot)))) : text::produce_simple_string(ws, "this_nation"));
	text::close_layout_box(layout, box);
}
void tf_num_of_cities_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	display_with_comparison(tval[0], text::produce_simple_string(ws, "num_owned_provinces"), text::produce_simple_string(ws, "num_provinces_owned_by"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, this_slot != -1 ? text::produce_simple_string(ws, ws.world.nation_get_name(nations::owner_of_pop(ws, trigger::to_pop(this_slot)))) : text::produce_simple_string(ws, "this_nation"));
	text::close_layout_box(layout, box);
}
...
void tf_exists_bool(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "exists" : "does_not_exist"));
	text::close_layout_box(layout, box);
}
...
void tf_has_building_state(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_has_comparison(tval[0], text::produce_simple_string(ws, ws.world.factory_type_get_name(trigger::payload(tval[1]).fac_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_ruling_party_ideology_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "ruling_party_ideology"), text::produce_simple_string(ws, ws.world.ideology_get_name(trigger::payload(tval[1]).ideo_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_ruling_party(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "ruling_party"), text::produce_simple_string(ws, ws.world.political_party_get_name(trigger::payload(tval[1]).par_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_ideology_enabled(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.world.ideology_get_name(trigger::payload(tval[1]).ideo_id)), text::produce_simple_string(ws, "enabled"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_is_primary_culture_nation_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "primary_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(trigger::to_nation(this_slot)))), ws, layout, box);
	else
...
void tf_is_primary_culture_nation_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "primary_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "primary_culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_nation_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "primary_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "primary_culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_state_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(trigger::to_nation(this_slot)))), ws, layout, box);
	else
...
void tf_is_primary_culture_state_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(nations::owner_of_pop(ws, trigger::to_pop(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_state_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_state_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_is_primary_culture_pop_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(nations::owner_of_pop(ws, trigger::to_pop(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_pop_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_primary_culture_pop_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.nation_get_primary_culture(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, "this_nation_primary_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_accepted_culture_pop(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, "an_accepted_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_accepted_culture_province(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, "an_accepted_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_is_next_reform_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "next_reform"), text::produce_simple_string(ws, ws.world.issue_option_get_name(trigger::payload(tval[1]).opt_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_is_next_rreform_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "next_reform"), text::produce_simple_string(ws, ws.world.reform_option_get_name(trigger::payload(tval[1]).ropt_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_rebel_power_fraction(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "never" : "always"));
	text::close_layout_box(layout, box);
}
...
void tf_is_canal_enabled(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, std::string("canal_") + std::to_string(tval[1])), text::produce_simple_string(ws, "enabled"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_is_possible_vassal(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], trigger::payload(tval[1]).tag_id, text::produce_simple_string(ws, "a_possible_vassal"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_province_id(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.world.province_get_name(trigger::payload(tval[1]).prov_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_crime_higher_than_education_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "admin_spending"), text::produce_simple_string(ws, "greater_than_edu_spending"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_has_global_flag(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.national_definitions.global_flag_variable_names[trigger::payload(tval[1]).glob_id]), text::produce_simple_string(ws, "set_globally"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_nationalvalue_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "national_value"), text::produce_simple_string(ws, ws.world.modifier_get_name(trigger::payload(tval[1]).mod_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_industrial_score_value(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "industrial_score"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_industrial_score_from_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "industrial_score"), text::produce_simple_string(ws, "industrial_score_of"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		text::add_to_layout_box(ws, layout, box, trigger::to_nation(from_slot));
	else
...
void tf_military_score_value(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "military_score"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_military_score_from_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "military_score"), text::produce_simple_string(ws, "military_score_of"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		text::add_to_layout_box(ws, layout, box, trigger::to_nation(from_slot));
	else
...
void tf_rich_tax(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "rich_tax"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_middle_tax(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "middle_tax"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_poor_tax(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "poor_tax"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_social_spending_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "social_spending"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_military_spending_pop(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "mil_spending"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_administration_spending_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "admin_spending"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_education_spending_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "edu_spending"), text::int_percentage{trigger::payload(tval[1]).signed_value}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_pop_majority_religion_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(trigger::payload(tval[1]).rel_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_pop_majority_culture_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_culture"), text::produce_simple_string(ws, ws.world.culture_get_name(trigger::payload(tval[1]).cul_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_pop_majority_issue_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_issue"), text::produce_simple_string(ws, ws.world.issue_option_get_name(trigger::payload(tval[1]).opt_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_pop_majority_ideology_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "dominant_ideology"), text::produce_simple_string(ws, ws.world.ideology_get_name(trigger::payload(tval[1]).ideo_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_rich_tax_above_poor(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "rich_tax"), text::produce_simple_string(ws, "gt_poor_tax"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_this_culture_union_tag(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), trigger::payload(tval[1]).tag_id, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_this_culture_union_from(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), trigger::to_nation(from_slot), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), text::produce_simple_string(ws, "from_nation"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_this_culture_union_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), trigger::to_nation(this_slot), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_this_culture_union_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot)), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_this_culture_union_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot)), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_this_culture_union_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), nations::owner_of_pop(ws, trigger::to_pop(this_slot)), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "cultural_union"), text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_num_of_vassals_no_substates(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "num_vassals_no_substates"), int64_t(tval[1]), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_brigades_compare_this(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "num_regiments"), text::produce_simple_string(ws, "num_regiments_of"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		text::add_to_layout_box(ws, layout, box, trigger::to_nation(this_slot));
	else
...
void tf_is_our_vassal_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_has_comparison(tval[0], ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot)), ws, layout, box);
	else
		display_with_has_comparison(tval[0], text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "as_a_vassal"));
...
void tf_is_our_vassal_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_has_comparison(tval[0], ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot)), ws, layout, box);
	else
		display_with_has_comparison(tval[0], text::produce_simple_string(ws, "this_nation"), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "as_a_vassal"));
...
void tf_is_releasable_vassal_from(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], trigger::to_nation(from_slot), text::produce_simple_string(ws, "a_releasable_vassal"), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "from_nation"), text::produce_simple_string(ws, "a_releasable_vassal"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_has_pop_culture_pop_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.pop_get_culture(trigger::to_pop(this_slot)))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, "this_pop_culture"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_has_pop_culture_state_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1) {
		display_with_has_comparison(tval[0], text::produce_simple_string(ws, ws.world.culture_get_name(ws.world.pop_get_culture(trigger::to_pop(this_slot)))), ws, layout, box);
		text::add_space_to_layout_box(ws, layout, box);
...
void tf_has_pop_culture_pop(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "culture"), text::produce_simple_string(ws, ws.world.culture_get_name(trigger::payload(tval[1]).cul_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_has_pop_culture_state(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_has_comparison(tval[0], text::produce_simple_string(ws, ws.world.culture_get_name(trigger::payload(tval[1]).cul_id)), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "pops"));
	text::close_layout_box(layout, box);
}
...
void tf_has_pop_religion_pop_this_pop(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "religion"), text::produce_simple_string(ws, ws.world.religion_get_name(trigger::payload(tval[1]).rel_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_has_pop_religion_state_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1) {
		display_with_has_comparison(tval[0], text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.pop_get_religion(trigger::to_pop(this_slot)))), ws, layout, box);
		text::add_space_to_layout_box(ws, layout, box);
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "pops"));
	} else {
		display_with_has_comparison(tval[0], text::produce_simple_string(ws, "pops_with"), ws, layout, box);
...
void tf_has_pop_religion_state(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_has_comparison(tval[0], text::produce_simple_string(ws, ws.world.religion_get_name(trigger::payload(tval[1]).rel_id)), ws, layout, box);
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "pops"));
	text::close_layout_box(layout, box);
}
...
void tf_trade_goods_in_state_state(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.world.commodity_get_name(trigger::payload(tval[1]).com_id)), text::produce_simple_string(ws, "present_in_state"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_crisis_exist(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "there"), text::produce_simple_string(ws, "an_ongoing_crisis"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_liberation_crisis(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "current_crisis"), text::produce_simple_string(ws, "liberation_crisis"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_is_claim_crisis(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "current_crisis"), text::produce_simple_string(ws, "claim_crisis"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_diplomatic_influence_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot)), int64_t(tval[1]), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "this_nation"), int64_t(tval[1]), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_diplomatic_influence_from_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], ws.world.province_get_nation_from_province_ownership(trigger::to_prov(from_slot)), int64_t(tval[1]), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "from_nation"), int64_t(tval[1]), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_relation_tag(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], trigger::payload(tval[2]).tag_id, int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_relation_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], trigger::to_nation(this_slot), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "this_nation"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_relation_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot)), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "this_nation"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_relation_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], trigger::to_nation(from_slot), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "from_nation"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_relation_from_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], ws.world.province_get_nation_from_province_ownership(trigger::to_prov(from_slot)), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "from_nation"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_check_variable(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.national_definitions.variable_names[trigger::payload(tval[3]).natv_id]), text::fp_percentage{trigger::read_float_from_payload(tval + 1)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_upper_house(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, ws.world.ideology_get_name(trigger::payload(tval[3]).ideo_id)));
	text::add_space_to_layout_box(ws, layout, box);
...
void tf_unemployment_by_type_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_to_layout_box(ws, layout, box, ws.world.pop_type_get_name(trigger::payload(tval[3]).popt_id));
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "unemployment_in_state"), text::fp_percentage{trigger::read_float_from_payload(tval + 1)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_party_loyalty_nation_province_id(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], trigger::payload(tval[1]).prov_id, int64_t(trigger::payload(tval[2]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_party_loyalty_nation_from_province(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], trigger::to_prov(from_slot), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "from_province"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_party_loyalty_generic(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_to_layout_box(ws, layout, box, ws.world.ideology_get_name(trigger::payload(tval[2]).ideo_id));
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "support"), int64_t(trigger::payload(tval[1]).signed_value), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_can_build_in_province_railroad_no_limit_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	if(from_slot != -1)
		...
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "from_nation"));
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "can_build_railroad_here" : "cannot_build_railroad_here"));
	text::close_layout_box(layout, box);
}
...
void tf_can_build_in_province_fort_no_limit_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	if(from_slot != -1)
		...
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "from_nation"));
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "can_build_fort_here" : "cannot_build_fort_here"));
	text::close_layout_box(layout, box);
}
...
void tf_can_build_in_province_naval_base_no_limit_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	if(from_slot != -1)
		...
		text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, "from_nation"));
	text::add_space_to_layout_box(ws, layout, box);
	text::add_to_layout_box(ws, layout, box, text::produce_simple_string(ws, (tval[0] & trigger::association_mask) == trigger::association_eq ? "can_build_naval_base_here" : "cannot_build_naval_base_here"));
	text::close_layout_box(layout, box);
}
...
void tf_work_available_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "work"), text::produce_simple_string(ws, "available_for"), ws, layout, box);
	text::add_to_layout_box(ws, layout, box, ws.world.pop_type_get_name(trigger::payload(tval[1]).popt_id));
	text::add_space_to_layout_box(ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_variable_ideology_name_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "support"), text::fp_percentage{trigger::read_float_from_payload(tval + 2)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_variable_issue_group_name_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, ws.world.issue_get_name(trigger::payload(tval[1]).iss_id)), text::produce_simple_string(ws, ws.world.issue_option_get_name(trigger::payload(tval[2]).opt_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_variable_pop_type_name_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_to_layout_box(ws, layout, box, ws.world.pop_type_get_name(trigger::payload(tval[1]).popt_id));
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "percentage"), text::fp_percentage_one_place{trigger::read_float_from_payload(tval + 2)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void tf_variable_pop_type_name_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_to_layout_box(ws, layout, box, ws.world.pop_type_get_name(trigger::payload(tval[1]).popt_id));
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "province_percentage"), text::fp_percentage_one_place{trigger::read_float_from_payload(tval + 2)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_variable_good_name(TRIGGER_DISPLAY_PARAMS) {
	...
	text::add_to_layout_box(ws, layout, box, ws.world.commodity_get_name(trigger::payload(tval[1]).com_id));
	text::add_space_to_layout_box(ws, layout, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "stockpile"), text::fp_percentage{trigger::read_float_from_payload(tval + 2)}, ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation(TRIGGER_DISPLAY_PARAMS) {
	auto box = text::open_layout_box(layout, indentation);
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(trigger::payload(tval[1]).rel_id)), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_reb(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.rebel_faction_get_religion(trigger::to_rebel(from_slot)))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "rebel_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_from_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(from_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.nation_get_religion(trigger::to_nation(from_slot)))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "from_nat_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_this_nation(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.nation_get_religion(trigger::to_nation(this_slot)))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "this_nat_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_this_state(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.nation_get_religion(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "this_nat_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_this_province(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.nation_get_religion(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "this_nat_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
void tf_religion_nation_this_pop(TRIGGER_DISPLAY_PARAMS) {
	...
	make_condition(tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition, box);
	if(this_slot != -1)
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, ws.world.religion_get_name(ws.world.nation_get_religion(nations::owner_of_pop(ws, trigger::to_pop(this_slot))))), ws, layout, box);
	else
		display_with_comparison(tval[0], text::produce_simple_string(ws, "national_religion"), text::produce_simple_string(ws, "this_nat_religion"), ws, layout, box);
	text::close_layout_box(layout, box);
}
...
void make_trigger_description(sys::state& ws, text::layout_base& layout, uint16_t const* tval, int32_t primary_slot, int32_t this_slot, int32_t from_slot, int32_t indentation, bool show_condition) {
	trigger_functions[*tval & trigger::code_mask](tval, ws, layout, primary_slot, this_slot, from_slot, indentation, show_condition);
}
...
void multiplicative_value_modifier_description(sys::state& state, text::layout_base& layout, dcon::value_modifier_key modifier, int32_t primary_slot, int32_t this_slot, int32_t from_slot) {
	...
	for(uint32_t i = 0; i < base.segments_count; ++i) {
		...
		if(seg.condition) {
			...
			trigger_tooltip::make_trigger_description(state, layout, state.trigger_data.data() + state.trigger_data_indices[seg.condition.index()], primary_slot, this_slot, from_slot, trigger_tooltip::indentation_amount * 2, true);
		}
	}
}
