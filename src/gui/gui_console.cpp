...
void ui::console_edit::edit_box_enter(sys::state& state, std::string_view s) noexcept {
	...
	case command_info::type::fire_national_event: {
		...
		log_to_console(state, parent, "Firing national event " + std::to_string(num));
		state.game_state_updated.store(true, std::memory_order::release);
	} break;
	case command_info::type::fire_free_national_event: {
		...
		ui::fire_event(state, id);
		log_to_console(state, parent, "Firing free national event " + std::to_string(num));
		state.game_state_updated.store(true, std::memory_order::release);
	} break;
	case command_info::type::fire_provincial_event: {
		...
		ui::fire_event(state, id);
		log_to_console(state, parent, "Firing provincial event " + std::to_string(num));
		state.game_state_updated.store(true, std::memory_order::release);
	} break;
	case command_info::type::fire_free_provincial_event: {
		...
		ui::fire_event(state, id);
		log_to_console(state, parent, "Firing free provincial event " + std::to_string(num));
		state.game_state_updated.store(true, std::memory_order::release);
	} break;
