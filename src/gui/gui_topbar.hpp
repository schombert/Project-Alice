  ...
  public:
	...
	void update_tooltip(sys::state& state, int32_t x, int32_t y, text::columnar_layout& contents) noexcept override {
		if(parent) {
			...
			text::localised_format_box(state, contents, box, std::string_view("tech_daily_leadership_tooltip"), sub);	// Hey, dont fucking change CSV values into completely invalid
