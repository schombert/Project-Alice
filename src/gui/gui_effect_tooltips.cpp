...
void display_value(int64_t value, bool positive_is_green,
                   sys::state &ws,
...
void display_value(text::fp_currency value, bool positive_is_green,
                   sys::state &ws,
                   text::layout_base &layout,
                   text::layout_box &box) {
...
void display_value(text::fp_percentage value, bool positive_is_green,
                   sys::state &ws,
                   text::layout_base &layout,
                   text::layout_box &box) {
...
void display_value(text::fp_one_place value, bool positive_is_green,
                   sys::state &ws,
                   text::layout_base &layout,
                   text::layout_box &box) {
...
void display_value(text::fp_two_places value, bool positive_is_green,
                   sys::state &ws,
                   text::layout_base &layout,
                   text::layout_box &box) {
...
void display_value(text::fp_three_places value, bool positive_is_green,
                   sys::state &ws,
                   text::layout_base &layout,
                   text::layout_box &box) {
...
uint32_t es_owner_scope_state(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          primary_slot != -1 ? trigger::to_generic(ws.world.state_instance_get_nation_from_state_ownership(trigger::to_state(primary_slot))) : -1,
...
uint32_t es_owner_scope_province(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          primary_slot != -1 ? trigger::to_generic(ws.world.province_get_nation_from_province_ownership(trigger::to_prov(primary_slot))) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
...
uint32_t es_capital_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          primary_slot != -1 ? trigger::to_generic(ws.world.nation_get_capital(trigger::to_nation(primary_slot))) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
...
uint32_t es_sea_zone_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          sea_zone ? trigger::to_generic(sea_zone) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
uint32_t es_cultural_union_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          trigger::to_generic(group_holder),
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
uint32_t es_overlord_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          trigger::to_generic(ws.world.overlord_get_ruler(olr)),
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
...
uint32_t es_independence_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          r_holder ? trigger::to_generic(r_holder) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
uint32_t es_flashpoint_tag_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          fp_nation ? trigger::to_generic(fp_nation) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
...
uint32_t es_tag_scope(EFFECT_DISPLAY_PARAMS) {
	...
	return display_subeffects(ws, tval, layout,
	                          tag_holder ? trigger::to_generic(tag_holder) : -1,
	                          this_slot, from_slot, r_hi, r_lo, indentation + indentation_amount);
}
...
uint32_t ef_primary_culture_this_nation(EFFECT_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		text::substitution_map m;
		add_to_map(ws, m, trigger::to_nation(this_slot), "this_nation_culture", [&](auto id) {
			return ws.world.culture_get_name(ws.world.nation_get_primary_culture(id));
		});
		text::localised_format_box(ws, layout, box, "primary_culture_changes_to", m);
		text::close_layout_box(layout, box);
	}
...
uint32_t ef_primary_culture_this_state(EFFECT_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		text::substitution_map m;
		add_to_map(ws, m, convert_this(ws, trigger::to_state(this_slot)), "this_nation_culture", [&](auto id) {
			return ws.world.culture_get_name(ws.world.nation_get_primary_culture(id));
		});
		text::localised_format_box(ws, layout, box, "primary_culture_changes_to", m);
		text::close_layout_box(layout, box);
...
uint32_t ef_primary_culture_this_province(EFFECT_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		text::substitution_map m;
		add_to_map(ws, m, convert_this(ws, trigger::to_prov(this_slot)), "this_nation_culture", [&](auto id) {
			return ws.world.culture_get_name(ws.world.nation_get_primary_culture(id));
		});
		text::localised_format_box(ws, layout, box, "primary_culture_changes_to", m);
		text::close_layout_box(layout, box);
...
uint32_t ef_primary_culture_this_pop(EFFECT_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		text::substitution_map m;
		add_to_map(ws, m, convert_this(ws, trigger::to_pop(this_slot)), "this_nation_culture", [&](auto id) {
			return ws.world.culture_get_name(ws.world.nation_get_primary_culture(id));
		});
		text::localised_format_box(ws, layout, box, "primary_culture_changes_to", m);
		text::close_layout_box(layout, box);
...
uint32_t ef_primary_culture_from_nation(EFFECT_DISPLAY_PARAMS) {
	{
		auto box = text::open_layout_box(layout, indentation);
		text::substitution_map m;
		add_to_map(ws, m, convert_this(ws, trigger::to_nation(from_slot)), "from_nation_culture", [&](auto id) {
			return ws.world.culture_get_name(ws.world.nation_get_primary_culture(id));
		});
		text::localised_format_box(ws, layout, box, "primary_culture_changes_to", m);
		text::close_layout_box(layout, box);
...
inline constexpr uint32_t (*effect_functions[])(EFFECT_DISPLAY_PARAMS) = {
    ...
    ef_country_event_immediate_province_this_province,     // constexpr inline uint16_t country_event_immediate_province_this_province = 0x0145;
...
uint32_t internal_make_effect_description(EFFECT_DISPLAY_PARAMS) {
	return effect_functions[*tval & effect::code_mask](ws, tval, layout, primary_slot, this_slot, from_slot, r_lo, r_hi, indentation);
}
