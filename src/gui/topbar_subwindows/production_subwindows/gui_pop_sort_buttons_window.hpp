...
public:
	void on_create(sys::state& state) noexcept override {
		...
		auto ptr = make_element_by_type<primary_worker_sort>(state, state.ui_state.defs_by_name.find("sort_by_pop_template")->second.definition);
		...
		auto ptr2 = make_element_by_type<secondary_worker_sort>(state, state.ui_state.defs_by_name.find("sort_by_pop_template")->second.definition);
		...
		auto ptr3 = make_element_by_type<owner_sort>(state, state.ui_state.defs_by_name.find("sort_by_pop_template")->second.definition);
