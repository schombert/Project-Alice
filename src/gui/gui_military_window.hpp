...
enum class military_window_sub_window : uint8_t {
	factories = 0x0,
	investments = 0x1,
	projects = 0x2,
	goods = 0x3
...
class military_window_tab_button : public checkbox_button {
public:
...
class military_window_close_button : public button_element_base {
public:
	void button_action(sys::state& state) noexcept override {
...
public:
	...
	message_result get(sys::state& state, Cyto::Any& payload) noexcept override {
		if(payload.holds_type<military_window_sub_window>()) {
			auto enum_val = any_cast<military_window_sub_window>(payload);
			hide_sub_windows(state);
			switch(enum_val) {
				case military_window_sub_window::factories:
					show_vector_elements(state, factory_elements);
					break;
				case military_window_sub_window::investments:
					show_vector_elements(state, investment_elements);
					break;
				case military_window_sub_window::projects:
					show_vector_elements(state, project_elements);
					break;
				case military_window_sub_window::goods:
	...
	military_window_sub_window active_sub_window = military_window_sub_window::factories;
};
