...
struct alignas(64) state {
	...
	state()
		: key_to_text_sequence(0, text::vector_backed_hash(text_data), text::vector_backed_eq(text_data)), incoming_commands(1024), new_n_event(1024), new_f_n_event(1024), new_p_event(1024), new_f_p_event(1024), new_requests(256), new_messages(1024), naval_battle_reports(256),
	...
	bool is_selected(dcon::army_id a) { return std::find(selected_armies.begin(), selected_armies.end(), a) != selected_armies.end(); }
	bool is_selected(dcon::navy_id a) { return std::find(selected_navies.begin(), selected_navies.end(), a) != selected_navies.end(); }
