...
struct message {
	...
	dcon::nation_id secondary; // optional; another nation that caused the thing to happen (for example, in a notification about a
														 // new war, the nation that declared the war, while the primary would be the target of the war).
