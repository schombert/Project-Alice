...
constexpr inline dcon::national_modifier_value mobilisation_size{71};
constexpr inline dcon::national_modifier_value mobilisation_economy_impact{72};
constexpr inline dcon::national_modifier_value global_pop_militancy_modifier{73};
constexpr inline dcon::national_modifier_value global_pop_consciousness_modifier{74};
constexpr inline dcon::national_modifier_value core_pop_militancy_modifier{75};
constexpr inline dcon::national_modifier_value core_pop_consciousness_modifier{76};
constexpr inline dcon::national_modifier_value non_accepted_pop_militancy_modifier{77};
constexpr inline dcon::national_modifier_value non_accepted_pop_consciousness_modifier{78};
constexpr inline dcon::national_modifier_value cb_generation_speed_modifier{79};
constexpr inline dcon::national_modifier_value mobilization_impact{80};
constexpr inline dcon::national_modifier_value suppression_points_modifier{81};
constexpr inline dcon::national_modifier_value education_efficiency_modifier{82};
constexpr inline dcon::national_modifier_value civilization_progress_modifier{83};
constexpr inline dcon::national_modifier_value administrative_efficiency_modifier{84};
constexpr inline dcon::national_modifier_value land_unit_start_experience{85};
constexpr inline dcon::national_modifier_value naval_unit_start_experience{86};
constexpr inline dcon::national_modifier_value naval_attack_modifier{87};
constexpr inline dcon::national_modifier_value naval_defense_modifier{88};
constexpr inline dcon::national_modifier_value land_attack_modifier{89};
constexpr inline dcon::national_modifier_value land_defense_modifier{90};
constexpr inline dcon::national_modifier_value tariff_efficiency_modifier{91};
constexpr inline dcon::national_modifier_value max_loan_modifier{92};
constexpr inline dcon::national_modifier_value unciv_economic_modifier{93};
constexpr inline dcon::national_modifier_value unciv_military_modifier{94};
constexpr inline dcon::national_modifier_value self_unciv_economic_modifier{95};
constexpr inline dcon::national_modifier_value self_unciv_military_modifier{96};
constexpr inline dcon::national_modifier_value commerce_tech_research_bonus{97};
constexpr inline dcon::national_modifier_value army_tech_research_bonus{98};
constexpr inline dcon::national_modifier_value industry_tech_research_bonus{99};
constexpr inline dcon::national_modifier_value navy_tech_research_bonus{100};
constexpr inline dcon::national_modifier_value culture_tech_research_bonus{101};
constexpr inline dcon::national_modifier_value supply_limit{102};
constexpr inline dcon::national_modifier_value colonial_migration{103};
constexpr inline dcon::national_modifier_value max_national_focus{104};
constexpr inline dcon::national_modifier_value cb_creation_speed{105};
constexpr inline dcon::national_modifier_value education_efficiency{106};
constexpr inline dcon::national_modifier_value diplomatic_points{107};
constexpr inline dcon::national_modifier_value reinforce_rate{108};
constexpr inline dcon::national_modifier_value tax_eff{109};
constexpr inline dcon::national_modifier_value administrative_efficiency{110};
constexpr inline dcon::national_modifier_value influence{111};
constexpr inline dcon::national_modifier_value dig_in_cap{112};
constexpr inline dcon::national_modifier_value combat_width{113};
constexpr inline dcon::national_modifier_value military_tactics{114};
constexpr inline dcon::national_modifier_value supply_range{115};
constexpr inline dcon::national_modifier_value regular_experience_level{116};
constexpr inline dcon::national_modifier_value soldier_to_pop_loss{117};
constexpr inline dcon::national_modifier_value naval_attrition{118};
constexpr inline dcon::national_modifier_value land_attrition{119};
constexpr inline dcon::national_modifier_value pop_growth{120};
constexpr inline dcon::national_modifier_value colonial_life_rating{121};
constexpr inline dcon::national_modifier_value seperatism{122};
constexpr inline dcon::national_modifier_value plurality{123};
constexpr inline dcon::national_modifier_value colonial_prestige{124};
constexpr inline dcon::national_modifier_value permanent_prestige{125};
constexpr inline dcon::national_modifier_value prestige_modifier{126};
