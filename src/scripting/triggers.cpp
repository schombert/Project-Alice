...
TRIGGER_FUNCTION(tf_continent_province) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(to_prov(primary_slot)), trigger::payload(tval[1]).mod_id);
}
TRIGGER_FUNCTION(tf_continent_state) {
	auto state_caps = ws.world.state_instance_get_capital(to_state(primary_slot));
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(state_caps), trigger::payload(tval[1]).mod_id);
}
TRIGGER_FUNCTION(tf_continent_nation) {
	auto nat_caps = ws.world.nation_get_capital(to_nation(primary_slot));
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(nat_caps), trigger::payload(tval[1]).mod_id);
}
TRIGGER_FUNCTION(tf_continent_pop) {
	auto prov_id = ws.world.pop_get_province_from_pop_location(to_pop(primary_slot));
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(prov_id), trigger::payload(tval[1]).mod_id);
}
TRIGGER_FUNCTION(tf_continent_nation_this) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(ws.world.nation_get_capital(to_nation(primary_slot))),
	                         ws.world.province_get_continent(ws.world.nation_get_capital(to_nation(this_slot))));
}
TRIGGER_FUNCTION(tf_continent_state_this) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(ws.world.state_instance_get_capital(to_state(primary_slot))),
	                         ws.world.province_get_continent(ws.world.nation_get_capital(to_nation(this_slot))));
}
TRIGGER_FUNCTION(tf_continent_province_this) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_continent(to_prov(primary_slot)),
	                         ws.world.province_get_continent(ws.world.nation_get_capital(to_nation(this_slot))));
}
...
TRIGGER_FUNCTION(tf_military_access_tag) {
	...
	auto result = ve::apply([&ws, holder](dcon::nation_id n) {
		return ws.world.unilateral_relationship_get_military_access(ws.world.get_unilateral_relationship_by_unilateral_pair(holder, n));
	},
	                        to_nation(primary_slot));
	return compare_to_true(tval[0], result);
}
TRIGGER_FUNCTION(tf_military_access_from) {
	auto result = ve::apply([&ws](dcon::nation_id n, dcon::nation_id t) {
		return ws.world.unilateral_relationship_get_military_access(ws.world.get_unilateral_relationship_by_unilateral_pair(t, n));
	},
	                        to_nation(primary_slot), to_nation(from_slot));
	return compare_to_true(tval[0], result);
}
...
TRIGGER_FUNCTION(tf_prestige_from) {
	return compare_values(tval[0], ws.world.nation_get_prestige(to_nation(primary_slot)), ws.world.nation_get_prestige(to_nation(from_slot)));
}
TRIGGER_FUNCTION(tf_prestige_this_nation) {
	return compare_values(tval[0], ws.world.nation_get_prestige(to_nation(primary_slot)), ws.world.nation_get_prestige(to_nation(this_slot)));
}
...
TRIGGER_FUNCTION(tf_has_building_fort) {
	return compare_to_true(tval[0], ws.world.province_get_fort_level(to_prov(primary_slot)) != 0);
}
TRIGGER_FUNCTION(tf_has_building_railroad) {
	return compare_to_true(tval[0], ws.world.province_get_railroad_level(to_prov(primary_slot)) != 0);
}
TRIGGER_FUNCTION(tf_has_building_naval_base) {
	return compare_to_true(tval[0], ws.world.province_get_naval_base_level(to_prov(primary_slot)) != 0);
}
...
TRIGGER_FUNCTION(tf_region) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_state_from_abstract_state_membership(to_prov(primary_slot)),
	                         trigger::payload(tval[1]).state_id);
}
TRIGGER_FUNCTION(tf_tag_tag) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_identity_from_identity_holder(to_nation(primary_slot)),
...
TRIGGER_FUNCTION(tf_tag_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_identity_from_identity_holder(owner),
	                         trigger::payload(tval[1]).tag_id);
}
...
TRIGGER_FUNCTION(tf_neighbour_this) {
	auto result = ve::apply([&ws](dcon::nation_id n, dcon::nation_id o) {
...
TRIGGER_FUNCTION(tf_war_with_tag) {
	...
	auto result = ve::apply([&ws, holder](dcon::nation_id a) {
		return military::are_at_war(ws, holder, a);
	},
	                        to_nation(primary_slot));
	return compare_to_true(tval[0], result);
}
...
TRIGGER_FUNCTION(tf_controlled_by_from) {
	return compare_values_eq(tval[0], ws.world.province_get_nation_from_province_control(to_prov(primary_slot)), to_nation(from_slot));
}
TRIGGER_FUNCTION(tf_controlled_by_this_nation) {
	return compare_values_eq(tval[0], ws.world.province_get_nation_from_province_control(to_prov(primary_slot)), to_nation(this_slot));
}
...
TRIGGER_FUNCTION(tf_controlled_by_reb) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_rebel_faction_from_province_rebel_control(to_prov(primary_slot)),
	                         to_rebel(from_slot));
}
TRIGGER_FUNCTION(tf_is_canal_enabled) {
	return compare_to_true(tval[0], (ws.world.province_adjacency_get_type(ws.province_definitions.canals[tval[1] - 1]) & province::border::impassible_bit) == 0);
}
TRIGGER_FUNCTION(tf_is_state_capital) {
	...
	return compare_values_eq(tval[0],
	                         ws.world.state_instance_get_capital(sid),
	                         to_prov(primary_slot));
}
...
TRIGGER_FUNCTION(tf_total_pops_nation) {
	return compare_values(tval[0],
	                      ws.world.nation_get_demographics(to_nation(primary_slot), demographics::total),
	                      read_float_from_payload(tval + 1));
}
TRIGGER_FUNCTION(tf_total_pops_state) {
	return compare_values(tval[0],
	                      ws.world.state_instance_get_demographics(to_state(primary_slot), demographics::total),
	                      read_float_from_payload(tval + 1));
}
TRIGGER_FUNCTION(tf_total_pops_province) {
	return compare_values(tval[0],
	                      ws.world.province_get_demographics(to_prov(primary_slot), demographics::total),
	                      read_float_from_payload(tval + 1));
}
TRIGGER_FUNCTION(tf_total_pops_pop) {
	auto location = ws.world.pop_get_province_from_pop_location(to_pop(primary_slot));
	return compare_values(tval[0],
	                      ws.world.province_get_demographics(location, demographics::total),
	                      read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_is_possible_vassal) {
	...
	auto result = ve::apply([&ws, tag](dcon::nation_id n) {
		return nations::can_release_as_vassal(ws, n, tag);
	},
	                        to_nation(primary_slot));
	return compare_to_true(tval[0], result);
}
...
TRIGGER_FUNCTION(tf_vassal_of_tag) {
	...
	return compare_values_eq(tval[0],
	                         ws.world.overlord_get_ruler(ws.world.nation_get_overlord_as_subject(to_nation(primary_slot))),
	                         tag_holder);
}
...
TRIGGER_FUNCTION(tf_substate_of_tag) {
	auto tag_holder = ws.world.national_identity_get_nation_from_identity_holder(payload(tval[1]).tag_id);
	return compare_to_true(tval[0],
	                       ws.world.nation_get_is_substate(to_nation(primary_slot)) && (ws.world.overlord_get_ruler(ws.world.nation_get_overlord_as_subject(to_nation(primary_slot))) ==
	                                                                                    tag_holder));
}
TRIGGER_FUNCTION(tf_substate_of_from) {
	return compare_to_true(tval[0],
	                       ws.world.nation_get_is_substate(to_nation(primary_slot)) && (ws.world.overlord_get_ruler(ws.world.nation_get_overlord_as_subject(to_nation(primary_slot))) == to_nation(from_slot)));
}
TRIGGER_FUNCTION(tf_substate_of_this_nation) {
	return compare_to_true(tval[0],
	                       ws.world.nation_get_is_substate(to_nation(primary_slot)) && (ws.world.overlord_get_ruler(ws.world.nation_get_overlord_as_subject(to_nation(primary_slot))) == to_nation(this_slot)));
}
TRIGGER_FUNCTION(tf_substate_of_this_province) {
	auto owner = ws.world.province_get_nation_from_province_ownership(to_prov(this_slot));
	return compare_to_true(tval[0],
	                       ws.world.nation_get_is_substate(to_nation(primary_slot)) && (ws.world.overlord_get_ruler(ws.world.nation_get_overlord_as_subject(to_nation(primary_slot))) == owner));
}
...
TRIGGER_FUNCTION(tf_alliance_with_from) {
	auto result = ve::apply([&ws](dcon::nation_id n, dcon::nation_id m) {
...
TRIGGER_FUNCTION(tf_crime_higher_than_education_nation) {
	return compare_to_true(tval[0],
	                       ws.world.nation_get_administrative_spending(to_nation(primary_slot)) >= ws.world.nation_get_education_spending(to_nation(primary_slot)));
}
TRIGGER_FUNCTION(tf_crime_higher_than_education_state) {
	auto owner = ws.world.state_instance_get_nation_from_state_ownership(to_state(primary_slot));
	return compare_to_true(tval[0],
	                       ws.world.nation_get_administrative_spending(owner) >= ws.world.nation_get_education_spending(owner));
}
...
TRIGGER_FUNCTION(tf_in_default_tag) {
	auto holder = ws.world.national_identity_get_nation_from_identity_holder(payload(tval[1]).tag_id);
	return compare_to_true(tval[0],
	                       ve::apply([&ws, holder](dcon::nation_id n) { return economy::is_bankrupt_debtor_to(ws, n, holder); }, to_nation(primary_slot)));
}
TRIGGER_FUNCTION(tf_in_default_from) {
	return compare_to_true(tval[0],
	                       ve::apply([&ws](dcon::nation_id n, dcon::nation_id h) { return economy::is_bankrupt_debtor_to(ws, n, h); }, to_nation(primary_slot), to_nation(from_slot)));
}
TRIGGER_FUNCTION(tf_in_default_this_nation) {
	return compare_to_true(tval[0],
	                       ve::apply([&ws](dcon::nation_id n, dcon::nation_id h) { return economy::is_bankrupt_debtor_to(ws, n, h); }, to_nation(primary_slot), to_nation(this_slot)));
}
TRIGGER_FUNCTION(tf_in_default_this_province) {
	auto owner = ws.world.province_get_nation_from_province_ownership(to_prov(this_slot));
	return compare_to_true(tval[0],
	                       ve::apply([&ws](dcon::nation_id n, dcon::nation_id h) { return economy::is_bankrupt_debtor_to(ws, n, h); }, to_nation(primary_slot), owner));
}
...
TRIGGER_FUNCTION(tf_nationalvalue_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_national_value(to_nation(primary_slot)),
	                         payload(tval[1]).mod_id);
}
TRIGGER_FUNCTION(tf_nationalvalue_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_national_value(owner),
	                         payload(tval[1]).mod_id);
}
...
TRIGGER_FUNCTION(tf_industrial_score_value) {
	return compare_values(tval[0],
	                      ws.world.nation_get_industrial_score(to_nation(primary_slot)),
	                      tval[1]);
}
...
TRIGGER_FUNCTION(tf_military_score_value) {
	return compare_values(tval[0],
	                      ws.world.nation_get_military_score(to_nation(primary_slot)),
	                      tval[1]);
}
...
TRIGGER_FUNCTION(tf_national_provinces_occupied) {
	return compare_values(tval[0], nations::occupied_provinces_fraction(ws, to_nation(primary_slot)), read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_rich_tax) {
	return compare_values(tval[0],
	                      ws.world.nation_get_rich_tax(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_middle_tax) {
	return compare_values(tval[0],
	                      ws.world.nation_get_middle_tax(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_poor_tax) {
	return compare_values(tval[0],
	                      ws.world.nation_get_poor_tax(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_social_spending_nation) {
	return compare_values(tval[0],
	                      ws.world.nation_get_social_spending(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_social_spending_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values(tval[0],
	                      ws.world.nation_get_social_spending(owner),
	                      payload(tval[1]).signed_value);
}
...
TRIGGER_FUNCTION(tf_military_spending_nation) {
	return compare_values(tval[0],
	                      ws.world.nation_get_military_spending(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_military_spending_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values(tval[0],
	                      ws.world.nation_get_military_spending(owner),
	                      payload(tval[1]).signed_value);
}
...
TRIGGER_FUNCTION(tf_administration_spending_nation) {
	return compare_values(tval[0],
	                      ws.world.nation_get_administrative_spending(to_nation(primary_slot)),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_administration_spending_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values(tval[0],
	                      ws.world.nation_get_administrative_spending(owner),
	                      payload(tval[1]).signed_value);
}
...
TRIGGER_FUNCTION(tf_education_spending_pop) {
	auto owner = nations::owner_of_pop(ws, to_pop(primary_slot));
	return compare_values(tval[0],
	                      ws.world.nation_get_education_spending(owner),
	                      payload(tval[1]).signed_value);
}
...
TRIGGER_FUNCTION(tf_pop_majority_religion_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_dominant_religion(to_nation(primary_slot)),
...
TRIGGER_FUNCTION(tf_pop_majority_culture_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_dominant_culture(to_nation(primary_slot)),
...
TRIGGER_FUNCTION(tf_pop_majority_issue_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_dominant_issue_option(to_nation(primary_slot)),
	                         payload(tval[1]).opt_id);
}
TRIGGER_FUNCTION(tf_pop_majority_issue_state) {
	return compare_values_eq(tval[0],
	                         ws.world.state_instance_get_dominant_issue_option(to_state(primary_slot)),
	                         payload(tval[1]).opt_id);
}
TRIGGER_FUNCTION(tf_pop_majority_issue_province) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_dominant_issue_option(to_prov(primary_slot)),
	                         payload(tval[1]).opt_id);
}
TRIGGER_FUNCTION(tf_pop_majority_issue_pop) {
	return compare_values_eq(tval[0],
	                         ws.world.pop_get_dominant_issue_option(to_pop(primary_slot)),
	                         payload(tval[1]).opt_id);
}
TRIGGER_FUNCTION(tf_pop_majority_ideology_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_dominant_ideology(to_nation(primary_slot)),
	                         payload(tval[1]).ideo_id);
}
TRIGGER_FUNCTION(tf_pop_majority_ideology_state) {
	return compare_values_eq(tval[0],
	                         ws.world.state_instance_get_dominant_ideology(to_state(primary_slot)),
	                         payload(tval[1]).ideo_id);
}
TRIGGER_FUNCTION(tf_pop_majority_ideology_province) {
	return compare_values_eq(tval[0],
	                         ws.world.province_get_dominant_ideology(to_prov(primary_slot)),
	                         payload(tval[1]).ideo_id);
}
TRIGGER_FUNCTION(tf_pop_majority_ideology_pop) {
	return compare_values_eq(tval[0],
	                         ws.world.pop_get_dominant_ideology(to_pop(primary_slot)),
	                         payload(tval[1]).ideo_id);
}
...
TRIGGER_FUNCTION(tf_poor_strata_militancy_pop) {
	...
	return compare_values(tval[0],
	                      ve::select(is_poor, ws.world.pop_get_militancy(to_pop(primary_slot)), 0.0f),
	                      read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_middle_strata_militancy_pop) {
	...
	return compare_values(tval[0],
	                      ve::select(is_middle, ws.world.pop_get_militancy(to_pop(primary_slot)), 0.0f),
	                      read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_rich_strata_militancy_pop) {
	...
	return compare_values(tval[0],
	                      ve::select(is_rich, ws.world.pop_get_militancy(to_pop(primary_slot)), 0.0f),
	                      read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_this_culture_union_from) {
	...
	return compare_values_eq(tval[0],
	                         utag,
	                         ws.world.nation_get_identity_from_identity_holder(to_nation(from_slot)));
}
TRIGGER_FUNCTION(tf_this_culture_union_this_nation) {
	...
	return compare_values_eq(tval[0],
	                         utag,
	                         ws.world.nation_get_identity_from_identity_holder(to_nation(this_slot)));
}
...
TRIGGER_FUNCTION(tf_social_movement) {
	return compare_to_true(tval[0], ve::apply([&ws](dcon::pop_id p) {
...
TRIGGER_FUNCTION(tf_has_pop_culture_state_this_pop) {
	auto culture = ws.world.pop_get_culture(to_pop(this_slot));
	auto result = ve::apply([&ws](dcon::state_instance_id s, dcon::culture_id c) {
...
TRIGGER_FUNCTION(tf_has_pop_culture_province_this_pop) {
	auto culture = ws.world.pop_get_culture(to_pop(this_slot));
	auto result = ve::apply([&ws](dcon::province_id s, dcon::culture_id c) {
...
TRIGGER_FUNCTION(tf_has_pop_culture_nation_this_pop) {
	auto culture = ws.world.pop_get_culture(to_pop(this_slot));
	auto result = ve::apply([&ws](dcon::nation_id s, dcon::culture_id c) {
...
TRIGGER_FUNCTION(tf_has_pop_religion_state_this_pop) {
	...
	auto result = ve::apply([&ws](dcon::state_instance_id s, dcon::religion_id r) {
...
TRIGGER_FUNCTION(tf_has_pop_religion_province_this_pop) {
	auto rel = ws.world.pop_get_religion(to_pop(this_slot));
	auto result = ve::apply([&ws](dcon::province_id s, dcon::religion_id r) {
...
TRIGGER_FUNCTION(tf_has_pop_religion_nation_this_pop) {
	auto rel = ws.world.pop_get_religion(to_pop(this_slot));
	auto result = ve::apply([&ws](dcon::nation_id s, dcon::religion_id r) {
...
TRIGGER_FUNCTION(tf_has_flashpoint) {
	return compare_to_true(tval[0], ws.world.state_instance_get_flashpoint_tag(to_state(primary_slot)) != dcon::national_identity_id());
}
TRIGGER_FUNCTION(tf_flashpoint_tension) {
	return compare_values(tval[0], ws.world.state_instance_get_flashpoint_tension(to_state(primary_slot)), read_float_from_payload(tval + 1));
}
...
TRIGGER_FUNCTION(tf_party_loyalty_nation_province_id) {
	return compare_values(tval[0],
	                      ws.world.province_get_party_loyalty(payload(tval[1]).prov_id, payload(tval[3]).ideo_id),
...
TRIGGER_FUNCTION(tf_party_loyalty_nation_from_province) {
	return compare_values(tval[0],
	                      ws.world.province_get_party_loyalty(to_prov(from_slot), payload(tval[2]).ideo_id),
	                      payload(tval[1]).signed_value);
}
TRIGGER_FUNCTION(tf_party_loyalty_generic) {
	return compare_values(tval[0],
	                      ws.world.province_get_party_loyalty(to_prov(primary_slot), payload(tval[2]).ideo_id),
	                      payload(tval[1]).signed_value);
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_railroad_no_limit_from_nation) {
	return compare_to_true(tval[0],
	                       ve::to_float(ws.world.province_get_railroad_level(to_prov(primary_slot))) + ws.world.province_get_modifier_values(to_prov(primary_slot), sys::provincial_mod_offsets::min_build_railroad) < ve::to_float(ws.world.nation_get_max_railroad_level(to_nation(from_slot))));
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_railroad_no_limit_this_nation) {
	return compare_to_true(tval[0],
	                       ve::to_float(ws.world.province_get_railroad_level(to_prov(primary_slot))) + ws.world.province_get_modifier_values(to_prov(primary_slot), sys::provincial_mod_offsets::min_build_railroad) < ve::to_float(ws.world.nation_get_max_railroad_level(to_nation(this_slot))));
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_fort_no_limit_from_nation) {
	return compare_to_true(tval[0],
	                       ws.world.province_get_fort_level(to_prov(primary_slot)) < ws.world.nation_get_max_fort_level(to_nation(from_slot)));
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_fort_no_limit_this_nation) {
	return compare_to_true(tval[0],
	                       ws.world.province_get_fort_level(to_prov(primary_slot)) < ws.world.nation_get_max_fort_level(to_nation(this_slot)));
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_naval_base_no_limit_from_nation) {
	auto result =
	    ws.world.province_get_is_coast(to_prov(primary_slot)) && (ws.world.province_get_naval_base_level(to_prov(primary_slot)) < ws.world.nation_get_max_naval_base_level(to_nation(from_slot))) && (ws.world.province_get_naval_base_level(to_prov(primary_slot)) != 0 || ve::apply([&ws](dcon::state_instance_id i) { return !(military::state_has_naval_base(ws, i)); }, ws.world.province_get_state_membership(to_prov(primary_slot))));
	return compare_to_true(tval[0], result);
}
...
TRIGGER_FUNCTION(tf_can_build_in_province_naval_base_no_limit_this_nation) {
	auto result =
	    ws.world.province_get_is_coast(to_prov(primary_slot)) && (ws.world.province_get_naval_base_level(to_prov(primary_slot)) < ws.world.nation_get_max_naval_base_level(to_nation(this_slot))) && (ws.world.province_get_naval_base_level(to_prov(primary_slot)) != 0 || ve::apply([&ws](dcon::state_instance_id i) { return !(military::state_has_naval_base(ws, i)); }, ws.world.province_get_state_membership(to_prov(primary_slot))));
	return compare_to_true(tval[0], result);
}
...
TRIGGER_FUNCTION(tf_religion_nation) {
	return compare_values_eq(tval[0],
	                         ws.world.nation_get_religion(to_nation(primary_slot)),
	                         payload(tval[1]).rel_id);
}
...
struct trigger_container {
	constexpr static return_type(CALLTYPE *trigger_functions[])(uint16_t const *, sys::state &,
	    ...
	    tf_life_rating_province<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t life_rating_province = 0x0007;
	    ...
	    tf_continent_nation_this<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t continent_nation_this = 0x007D;
	    tf_continent_state_this<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t continent_state_this = 0x007E;
	    tf_continent_province_this<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t continent_province_this = 0x007F;
	    tf_continent_pop_this<return_type, primary_type, this_type, from_type>,                                     // constexpr inline uint16_t continent_pop_this = 0x0080;
	    tf_continent_nation_from<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t continent_nation_from = 0x0081;
	    tf_continent_state_from<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t continent_state_from = 0x0082;
	    tf_continent_province_from<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t continent_province_from = 0x0083;
	    ...
	    tf_casus_belli_this_nation<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t casus_belli_this_nation = 0x0087;
	    tf_casus_belli_this_state<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t casus_belli_this_state = 0x0088;
	    tf_casus_belli_this_province<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t casus_belli_this_province = 0x0089;
	    tf_casus_belli_this_pop<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t casus_belli_this_pop = 0x008A;
	    tf_military_access_tag<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t military_access_tag = 0x008B;
	    tf_military_access_from<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t military_access_from = 0x008C;
	    tf_military_access_this_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t military_access_this_nation = 0x008D;
	    tf_military_access_this_state<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t military_access_this_state = 0x008E;
	    tf_military_access_this_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t military_access_this_province = 0x008F;
	    tf_military_access_this_pop<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t military_access_this_pop = 0x0090;
	    ...
	    tf_prestige_this_nation<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t prestige_this_nation = 0x0093;
	    tf_prestige_this_state<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t prestige_this_state = 0x0094;
	    tf_prestige_this_province<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t prestige_this_province = 0x0095;
	    ...
	    tf_has_building_railroad<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_building_railroad = 0x009A;
	    tf_has_building_naval_base<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t has_building_naval_base = 0x009B;
	    ...
	    tf_has_country_modifier<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t has_country_modifier = 0x009E;
	    tf_has_province_modifier<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_province_modifier = 0x009F;
	    ...
	    tf_units_in_province_value<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t units_in_province_value = 0x00A9;
	    tf_units_in_province_from<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t units_in_province_from = 0x00AA;
	    tf_units_in_province_this_nation<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t units_in_province_this_nation = 0x00AB;
	    tf_units_in_province_this_province<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t units_in_province_this_province = 0x00AC;
	    tf_units_in_province_this_state<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t units_in_province_this_state = 0x00AD;
	    tf_units_in_province_this_pop<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t units_in_province_this_pop = 0x00AE;
	    ...
	    tf_war_with_this_nation<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t war_with_this_nation = 0x00B1;
	    tf_war_with_this_province<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t war_with_this_province = 0x00B2;
	    ...
	    tf_is_next_reform_nation<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t is_next_reform_nation = 0x00EF;
	    tf_is_next_reform_pop<return_type, primary_type, this_type, from_type>,                                     // constexpr inline uint16_t is_next_reform_pop = 0x00F0;
	    tf_rebel_power_fraction<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t rebel_power_fraction = 0x00F1;
	    tf_recruited_percentage_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t recruited_percentage_nation = 0x00F2;
	    tf_recruited_percentage_pop<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t recruited_percentage_pop = 0x00F3;
	    ...
	    tf_controlled_by_rebels<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t controlled_by_rebels = 0x00F7;
	    ...
	    tf_controlled_by_this_nation<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t controlled_by_this_nation = 0x00FA;
	    tf_controlled_by_this_province<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t controlled_by_this_province = 0x00FB;
	    tf_controlled_by_this_state<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t controlled_by_this_state = 0x00FC;
	    tf_controlled_by_this_pop<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t controlled_by_this_pop = 0x00FD;
	    tf_controlled_by_owner<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t controlled_by_owner = 0x00FE;
	    ...
	    tf_truce_with_this_nation<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t truce_with_this_nation = 0x0104;
	    tf_truce_with_this_province<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t truce_with_this_province = 0x0105;
	    tf_truce_with_this_state<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t truce_with_this_state = 0x0106;
	    tf_truce_with_this_pop<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t truce_with_this_pop = 0x0107;
	    ...
	    tf_total_pops_province<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t total_pops_province = 0x010A;
	    tf_total_pops_pop<return_type, primary_type, this_type, from_type>,                                         // constexpr inline uint16_t total_pops_pop = 0x010B;
	    tf_has_pop_type_nation<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t has_pop_type_nation = 0x010C;
	    tf_has_pop_type_state<return_type, primary_type, this_type, from_type>,                                     // constexpr inline uint16_t has_pop_type_state = 0x010D;
	    tf_has_pop_type_province<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_pop_type_province = 0x010E;
	    tf_has_pop_type_pop<return_type, primary_type, this_type, from_type>,                                       // constexpr inline uint16_t has_pop_type_pop = 0x010F;
	    tf_has_empty_adjacent_province<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t has_empty_adjacent_province = 0x0110;
	    ...
	    tf_vassal_of_this_nation<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t vassal_of_this_nation = 0x0118;
	    tf_vassal_of_this_province<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t vassal_of_this_province = 0x0119;
	    tf_vassal_of_this_state<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t vassal_of_this_state = 0x011A;
	    ...
	    tf_alliance_with_this_nation<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t alliance_with_this_nation = 0x011E;
	    tf_alliance_with_this_province<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t alliance_with_this_province = 0x011F;
	    tf_alliance_with_this_state<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t alliance_with_this_state = 0x0120;
	    tf_alliance_with_this_pop<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t alliance_with_this_pop = 0x0121;
	    tf_has_recently_lost_war<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_recently_lost_war = 0x0122;
	    ...
	    tf_crime_higher_than_education_nation<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t crime_higher_than_education_nation = 0x0125;
	    tf_crime_higher_than_education_state<return_type, primary_type, this_type, from_type>,                      // constexpr inline uint16_t crime_higher_than_education_state = 0x0126;
	    tf_crime_higher_than_education_province<return_type, primary_type, this_type, from_type>,                   // constexpr inline uint16_t crime_higher_than_education_province = 0x0127;
	    tf_crime_higher_than_education_pop<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t crime_higher_than_education_pop = 0x0128;
	    tf_agree_with_ruling_party<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t agree_with_ruling_party = 0x0129;
	    tf_is_colonial_state<return_type, primary_type, this_type, from_type>,                                      // constexpr inline uint16_t is_colonial_state = 0x012A;
	    tf_is_colonial_province<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t is_colonial_province = 0x012B;
	    ...
	    tf_in_default_this_nation<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t in_default_this_nation = 0x012F;
	    tf_in_default_this_province<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t in_default_this_province = 0x0130;
	    tf_in_default_this_state<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t in_default_this_state = 0x0131;
	    tf_in_default_this_pop<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t in_default_this_pop = 0x0132;
	    ...
	    tf_nationalvalue_nation<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t nationalvalue_nation = 0x0138;
	    tf_industrial_score_value<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t industrial_score_value = 0x0139;
	    tf_industrial_score_from_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t industrial_score_from_nation = 0x013A;
	    tf_industrial_score_this_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t industrial_score_this_nation = 0x013B;
	    tf_industrial_score_this_pop<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t industrial_score_this_pop = 0x013C;
	    tf_industrial_score_this_state<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t industrial_score_this_state = 0x013D;
	    tf_industrial_score_this_province<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t industrial_score_this_province = 0x013E;
	    tf_military_score_value<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t military_score_value = 0x013F;
	    tf_military_score_from_nation<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t military_score_from_nation = 0x0140;
	    tf_military_score_this_nation<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t military_score_this_nation = 0x0141;
	    tf_military_score_this_pop<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t military_score_this_pop = 0x0142;
	    tf_military_score_this_state<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t military_score_this_state = 0x0143;
	    tf_military_score_this_province<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t military_score_this_province = 0x0144;
	    ...
	    tf_national_provinces_occupied<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t national_provinces_occupied = 0x0148;
	    tf_is_greater_power_nation<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t is_greater_power_nation = 0x0149;
	    tf_is_greater_power_pop<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t is_greater_power_pop = 0x014A;
	    ...
	    tf_social_spending_nation<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t social_spending_nation = 0x014E;
	    tf_social_spending_pop<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t social_spending_pop = 0x014F;
	    tf_social_spending_province<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t social_spending_province = 0x0150;
	    tf_colonial_nation<return_type, primary_type, this_type, from_type>,                                        // constexpr inline uint16_t colonial_nation = 0x0151;
	    tf_pop_majority_religion_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t pop_majority_religion_nation = 0x0152;
	    tf_pop_majority_religion_state<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t pop_majority_religion_state = 0x0153;
	    tf_pop_majority_religion_province<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t pop_majority_religion_province = 0x0154;
	    tf_pop_majority_culture_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t pop_majority_culture_nation = 0x0155;
	    tf_pop_majority_culture_state<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t pop_majority_culture_state = 0x0156;
	    tf_pop_majority_culture_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t pop_majority_culture_province = 0x0157;
	    tf_pop_majority_issue_nation<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t pop_majority_issue_nation = 0x0158;
	    tf_pop_majority_issue_state<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t pop_majority_issue_state = 0x0159;
	    tf_pop_majority_issue_province<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t pop_majority_issue_province = 0x015A;
	    tf_pop_majority_issue_pop<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t pop_majority_issue_pop = 0x015B;
	    tf_pop_majority_ideology_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t pop_majority_ideology_nation = 0x015C;
	    tf_pop_majority_ideology_state<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t pop_majority_ideology_state = 0x015D;
	    tf_pop_majority_ideology_province<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t pop_majority_ideology_province = 0x015E;
	    tf_pop_majority_ideology_pop<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t pop_majority_ideology_pop = 0x015F;
	    tf_poor_strata_militancy_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t poor_strata_militancy_nation = 0x0160;
	    tf_poor_strata_militancy_state<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t poor_strata_militancy_state = 0x0161;
	    tf_poor_strata_militancy_province<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t poor_strata_militancy_province = 0x0162;
	    tf_poor_strata_militancy_pop<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t poor_strata_militancy_pop = 0x0163;
	    tf_middle_strata_militancy_nation<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t middle_strata_militancy_nation = 0x0164;
	    tf_middle_strata_militancy_state<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t middle_strata_militancy_state = 0x0165;
	    tf_middle_strata_militancy_province<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t middle_strata_militancy_province = 0x0166;
	    tf_middle_strata_militancy_pop<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t middle_strata_militancy_pop = 0x0167;
	    tf_rich_strata_militancy_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t rich_strata_militancy_nation = 0x0168;
	    tf_rich_strata_militancy_state<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t rich_strata_militancy_state = 0x0169;
	    tf_rich_strata_militancy_province<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t rich_strata_militancy_province = 0x016A;
	    tf_rich_strata_militancy_pop<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t rich_strata_militancy_pop = 0x016B;
	    tf_rich_tax_above_poor<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t rich_tax_above_poor = 0x016C;
	    tf_culture_has_union_tag_pop<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t culture_has_union_tag_pop = 0x016D;
	    tf_culture_has_union_tag_nation<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t culture_has_union_tag_nation = 0x016E;
	    tf_this_culture_union_tag<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t this_culture_union_tag = 0x016F;
	    tf_this_culture_union_from<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t this_culture_union_from = 0x0170;
	    tf_this_culture_union_this_nation<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t this_culture_union_this_nation = 0x0171;
	    tf_this_culture_union_this_province<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t this_culture_union_this_province = 0x0172;
	    tf_this_culture_union_this_state<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t this_culture_union_this_state = 0x0173;
	    tf_this_culture_union_this_pop<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t this_culture_union_this_pop = 0x0174;
	    tf_this_culture_union_this_union_nation<return_type, primary_type, this_type, from_type>,                   // constexpr inline uint16_t this_culture_union_this_union_nation = 0x0175;
	    ...
	    tf_is_releasable_vassal_from<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t is_releasable_vassal_from = 0x01A5;
	    tf_is_releasable_vassal_other<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t is_releasable_vassal_other = 0x01A6;
	    tf_has_recent_imigration<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_recent_imigration = 0x01A7;
	    tf_province_control_days<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t province_control_days = 0x01A8;
	    ...
	    tf_someone_can_form_union_tag_from<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t someone_can_form_union_tag_from = 0x01AB;
	    tf_someone_can_form_union_tag_other<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t someone_can_form_union_tag_other = 0x01AC;
	    tf_social_movement_strength<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t social_movement_strength = 0x01AD;
	    tf_political_movement_strength<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t political_movement_strength = 0x01AE;
	    tf_can_build_factory_in_capital_state<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t can_build_factory_in_capital_state = 0x01AF;
	    ...
	    tf_has_cultural_sphere<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t has_cultural_sphere = 0x01B2;
	    tf_world_wars_enabled<return_type, primary_type, this_type, from_type>,                                     // constexpr inline uint16_t world_wars_enabled = 0x01B3;
	    tf_has_pop_culture_pop_this_pop<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t has_pop_culture_pop_this_pop = 0x01B4;
	    tf_has_pop_culture_state_this_pop<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t has_pop_culture_state_this_pop = 0x01B5;
	    tf_has_pop_culture_province_this_pop<return_type, primary_type, this_type, from_type>,                      // constexpr inline uint16_t has_pop_culture_province_this_pop = 0x01B6;
	    tf_has_pop_culture_nation_this_pop<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t has_pop_culture_nation_this_pop = 0x01B7;
	    tf_has_pop_culture_pop<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t has_pop_culture_pop = 0x01B8;
	    tf_has_pop_culture_state<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t has_pop_culture_state = 0x01B9;
	    tf_has_pop_culture_province<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t has_pop_culture_province = 0x01BA;
	    tf_has_pop_culture_nation<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t has_pop_culture_nation = 0x01BB;
	    tf_has_pop_religion_pop_this_pop<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t has_pop_religion_pop_this_pop = 0x01BC;
	    tf_has_pop_religion_state_this_pop<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t has_pop_religion_state_this_pop = 0x01BD;
	    tf_has_pop_religion_province_this_pop<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t has_pop_religion_province_this_pop = 0x01BE;
	    tf_has_pop_religion_nation_this_pop<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t has_pop_religion_nation_this_pop = 0x01BF;
	    tf_has_pop_religion_pop<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t has_pop_religion_pop = 0x01C0;
	    tf_has_pop_religion_state<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t has_pop_religion_state = 0x01C1;
	    tf_has_pop_religion_province<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t has_pop_religion_province = 0x01C2;
	    tf_has_pop_religion_nation<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t has_pop_religion_nation = 0x01C3;
	    ...
	    tf_consciousness_province<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t consciousness_province = 0x01C8;
	    tf_consciousness_state<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t consciousness_state = 0x01C9;
	    tf_consciousness_nation<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t consciousness_nation = 0x01CA;
	    ...
	    tf_military_spending_pop<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t military_spending_pop = 0x01D3;
	    tf_military_spending_province<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t military_spending_province = 0x01D4;
	    tf_military_spending_state<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t military_spending_state = 0x01D5;
	    tf_military_spending_nation<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t military_spending_nation = 0x01D6;
	    tf_administration_spending_pop<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t administration_spending_pop = 0x01D7;
	    tf_administration_spending_province<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t administration_spending_province = 0x01D8;
	    tf_administration_spending_state<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t administration_spending_state = 0x01D9;
	    tf_administration_spending_nation<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t administration_spending_nation = 0x01DA;
	    tf_education_spending_pop<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t education_spending_pop = 0x01DB;
	    tf_education_spending_province<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t education_spending_province = 0x01DC;
	    tf_education_spending_state<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t education_spending_state = 0x01DD;
	    tf_education_spending_nation<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t education_spending_nation = 0x01DE;
	    tf_trade_goods_in_state_state<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t trade_goods_in_state_state = 0x01DF;
	    tf_trade_goods_in_state_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t trade_goods_in_state_province = 0x01E0;
	    ...
	    tf_is_liberation_crisis<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t is_liberation_crisis = 0x01E4;
	    ...
	    tf_unemployment_by_type_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t unemployment_by_type_nation = 0x0220;
	    tf_unemployment_by_type_state<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t unemployment_by_type_state = 0x0221;
	    tf_unemployment_by_type_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t unemployment_by_type_province = 0x0222;
	    tf_unemployment_by_type_pop<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t unemployment_by_type_pop = 0x0223;
	    tf_party_loyalty_nation_province_id<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t party_loyalty_nation_province_id = 0x0224;
	    tf_party_loyalty_from_nation_province_id<return_type, primary_type, this_type, from_type>,                  // constexpr inline uint16_t party_loyalty_from_nation_province_id = 0x0225;
	    tf_party_loyalty_province_province_id<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t party_loyalty_province_province_id = 0x0226;
	    tf_party_loyalty_from_province_province_id<return_type, primary_type, this_type, from_type>,                // constexpr inline uint16_t party_loyalty_from_province_province_id = 0x0227;
	    tf_party_loyalty_nation_from_province<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t party_loyalty_nation_from_province = 0x0228;
	    tf_party_loyalty_from_nation_scope_province<return_type, primary_type, this_type, from_type>,               // constexpr inline uint16_t party_loyalty_from_nation_scope_province = 0x0229;
	    tf_can_build_in_province_railroad_no_limit_from_nation<return_type, primary_type, this_type, from_type>,    // constexpr inline uint16_t can_build_in_province_railroad_no_limit_from_nation = 0x022A;
	    tf_can_build_in_province_railroad_yes_limit_from_nation<return_type, primary_type, this_type, from_type>,   // constexpr inline uint16_t can_build_in_province_railroad_yes_limit_from_nation = 0x022B;
	    tf_can_build_in_province_railroad_no_limit_this_nation<return_type, primary_type, this_type, from_type>,    // constexpr inline uint16_t can_build_in_province_railroad_no_limit_this_nation = 0x022C;
	    tf_can_build_in_province_railroad_yes_limit_this_nation<return_type, primary_type, this_type, from_type>,   // constexpr inline uint16_t can_build_in_province_railroad_yes_limit_this_nation = 0x022D;
	    tf_can_build_in_province_fort_no_limit_from_nation<return_type, primary_type, this_type, from_type>,        // constexpr inline uint16_t can_build_in_province_fort_no_limit_from_nation = 0x022E;
	    tf_can_build_in_province_fort_yes_limit_from_nation<return_type, primary_type, this_type, from_type>,       // constexpr inline uint16_t can_build_in_province_fort_yes_limit_from_nation = 0x022F;
	    tf_can_build_in_province_fort_no_limit_this_nation<return_type, primary_type, this_type, from_type>,        // constexpr inline uint16_t can_build_in_province_fort_no_limit_this_nation = 0x0230;
	    tf_can_build_in_province_fort_yes_limit_this_nation<return_type, primary_type, this_type, from_type>,       // constexpr inline uint16_t can_build_in_province_fort_yes_limit_this_nation = 0x0231;
	    tf_can_build_in_province_naval_base_no_limit_from_nation<return_type, primary_type, this_type, from_type>,  // constexpr inline uint16_t can_build_in_province_naval_base_no_limit_from_nation = 0x0232;
	    tf_can_build_in_province_naval_base_yes_limit_from_nation<return_type, primary_type, this_type, from_type>, // constexpr inline uint16_t can_build_in_province_naval_base_yes_limit_from_nation = 0x0233;
	    tf_can_build_in_province_naval_base_no_limit_this_nation<return_type, primary_type, this_type, from_type>,  // constexpr inline uint16_t can_build_in_province_naval_base_no_limit_this_nation = 0x0234;
	    tf_can_build_in_province_naval_base_yes_limit_this_nation<return_type, primary_type, this_type, from_type>, // constexpr inline uint16_t can_build_in_province_naval_base_yes_limit_this_nation = 0x0235;
	    tf_can_build_railway_in_capital_yes_whole_state_yes_limit<return_type, primary_type, this_type, from_type>, // constexpr inline uint16_t can_build_railway_in_capital_yes_whole_state_yes_limit = 0x0236;
	    tf_can_build_railway_in_capital_yes_whole_state_no_limit<return_type, primary_type, this_type, from_type>,  // constexpr inline uint16_t can_build_railway_in_capital_yes_whole_state_no_limit = 0x0237;
	    tf_can_build_railway_in_capital_no_whole_state_yes_limit<return_type, primary_type, this_type, from_type>,  // constexpr inline uint16_t can_build_railway_in_capital_no_whole_state_yes_limit = 0x0238;
	    tf_can_build_railway_in_capital_no_whole_state_no_limit<return_type, primary_type, this_type, from_type>,   // constexpr inline uint16_t can_build_railway_in_capital_no_whole_state_no_limit = 0x0239;
	    tf_can_build_fort_in_capital_yes_whole_state_yes_limit<return_type, primary_type, this_type, from_type>,    // constexpr inline uint16_t can_build_fort_in_capital_yes_whole_state_yes_limit = 0x023A;
	    tf_can_build_fort_in_capital_yes_whole_state_no_limit<return_type, primary_type, this_type, from_type>,     // constexpr inline uint16_t can_build_fort_in_capital_yes_whole_state_no_limit = 0x023B;
	    tf_can_build_fort_in_capital_no_whole_state_yes_limit<return_type, primary_type, this_type, from_type>,     // constexpr inline uint16_t can_build_fort_in_capital_no_whole_state_yes_limit = 0x023C;
	    tf_can_build_fort_in_capital_no_whole_state_no_limit<return_type, primary_type, this_type, from_type>,      // constexpr inline uint16_t can_build_fort_in_capital_no_whole_state_no_limit = 0x023D;
	    tf_work_available_nation<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t work_available_nation = 0x023E;
	    tf_work_available_state<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t work_available_state = 0x023F;
	    tf_work_available_province<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t work_available_province = 0x0240;
	    tf_variable_ideology_name_nation<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t variable_ideology_name_nation = 0x0241;
	    tf_variable_ideology_name_state<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t variable_ideology_name_state = 0x0242;
	    tf_variable_ideology_name_province<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t variable_ideology_name_province = 0x0243;
	    tf_variable_ideology_name_pop<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t variable_ideology_name_pop = 0x0244;
	    tf_variable_issue_name_nation<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t variable_issue_name_nation = 0x0245;
	    tf_variable_issue_name_state<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t variable_issue_name_state = 0x0246;
	    tf_variable_issue_name_province<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t variable_issue_name_province = 0x0247;
	    tf_variable_issue_name_pop<return_type, primary_type, this_type, from_type>,                                // constexpr inline uint16_t variable_issue_name_pop = 0x0248;
	    tf_variable_issue_group_name_nation<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t variable_issue_group_name_nation = 0x0249;
	    tf_variable_issue_group_name_state<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t variable_issue_group_name_state = 0x024A;
	    tf_variable_issue_group_name_province<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t variable_issue_group_name_province = 0x024B;
	    tf_variable_issue_group_name_pop<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t variable_issue_group_name_pop = 0x024C;
	    tf_variable_pop_type_name_nation<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t variable_pop_type_name_nation = 0x024D;
	    tf_variable_pop_type_name_state<return_type, primary_type, this_type, from_type>,                           // constexpr inline uint16_t variable_pop_type_name_state = 0x024E;
	    tf_variable_pop_type_name_province<return_type, primary_type, this_type, from_type>,                        // constexpr inline uint16_t variable_pop_type_name_province = 0x024F;
	    tf_variable_pop_type_name_pop<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t variable_pop_type_name_pop = 0x0250;
	    ...
	    tf_party_loyalty_from_province_scope_province<return_type, primary_type, this_type, from_type>,             // constexpr inline uint16_t party_loyalty_from_province_scope_province = 0x0254;
	    ...
	    tf_nationalvalue_province<return_type, primary_type, this_type, from_type>,                                 // constexpr inline uint16_t nationalvalue_province = 0x0258;
	    tf_war_exhaustion_pop<return_type, primary_type, this_type, from_type>,                                     // constexpr inline uint16_t war_exhaustion_pop = 0x0259;
	    tf_has_culture_core_province_this_pop<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t has_culture_core_province_this_pop = 0x025A;
	    tf_tag_pop<return_type, primary_type, this_type, from_type>,                                                // constexpr inline uint16_t tag_pop = 0x025B;
	    tf_has_country_flag_pop<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t has_country_flag_pop = 0x025C;
	    tf_has_country_flag_province<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t has_country_flag_province = 0x025D;
	    tf_has_country_modifier_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t has_country_modifier_province = 0x025E;
	    tf_religion_nation<return_type, primary_type, this_type, from_type>,                                        // constexpr inline uint16_t religion_nation = 0x025F;
	    tf_religion_nation_reb<return_type, primary_type, this_type, from_type>,                                    // constexpr inline uint16_t religion_nation_reb = 0x0260;
	    tf_religion_nation_from_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t religion_nation_from_nation = 0x0261;
	    tf_religion_nation_this_nation<return_type, primary_type, this_type, from_type>,                            // constexpr inline uint16_t religion_nation_this_nation = 0x0262;
	    tf_religion_nation_this_state<return_type, primary_type, this_type, from_type>,                             // constexpr inline uint16_t religion_nation_this_state = 0x0263;
	    tf_religion_nation_this_province<return_type, primary_type, this_type, from_type>,                          // constexpr inline uint16_t religion_nation_this_province = 0x0264;
	    tf_religion_nation_this_pop<return_type, primary_type, this_type, from_type>,                               // constexpr inline uint16_t religion_nation_this_pop = 0x0265;
	    ...
	    tf_is_greater_power_province<return_type, primary_type, this_type, from_type>,                              // constexpr inline uint16_t is_greater_power_province = 0x0267;
	    tf_is_cultural_union_pop_this_pop<return_type, primary_type, this_type, from_type>,                         // constexpr inline uint16_t is_cultural_union_pop_this_pop = 0x0268;
	    tf_has_building_factory<return_type, primary_type, this_type, from_type>,                                   // constexpr inline uint16_t has_building_factory = 0x0269;
	    tf_has_building_state_from_province<return_type, primary_type, this_type, from_type>,                       // constexpr inline uint16_t has_building_state_from_province = 0x026A;
	    tf_has_building_factory_from_province<return_type, primary_type, this_type, from_type>,                     // constexpr inline uint16_t has_building_factory_from_province = 0x026B;
	    tf_party_loyalty_generic<return_type, primary_type, this_type, from_type>,                                  // constexpr inline uint16_t party_loyalty_generic = 0x026C;
