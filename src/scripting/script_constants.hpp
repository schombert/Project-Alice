...
EFFECT_BYTECODE_ELEMENT(0x01C3, set_global_variable, 3) \
EFFECT_BYTECODE_ELEMENT(0x01C4, change_global_variable, 3) \
...
constexpr inline uint16_t first_scope_code = 0x01C5;
