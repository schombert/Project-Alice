...
typedef enum {
    ...
    PLUTOVG_PAIN_TYPE_SUBPXTEXTURE,
...
typedef struct {
        plutovg_paint_t base;
        plutovg_surface_t* surface_lx_ly;
        plutovg_surface_t* surface_sx_sy;
        plutovg_surface_t* surface_lx_sy;
        plutovg_surface_t* surface_sx_ly;
        float opacity;
        float real_x_extent;
        float real_y_extent;
        plutovg_matrix_t matrix;
} plutovg_subpx_texture_paint_t;
